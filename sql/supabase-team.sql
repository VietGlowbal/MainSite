...
insert into public.team_members (
  ...
  'nguyen-khanh-linh',
  'Founder',
  'Scholarship recipient, student advisor, and international exchange student helping students build stronger study-abroad plans.',
  'VinUniversity',
...
cross join (values
  ...
  ('mentoring', 'Advised students who earned major VinUniversity scholarships',
   'Advised 3 students who earned 75%, 2 students who earned 80%, and multiple students who earned 70% VinUniversity Merit-based Scholarships.', null::int, 2),
