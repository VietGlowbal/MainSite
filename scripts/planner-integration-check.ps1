...
$migrations = @('supabase-core3-plan-hierarchy.sql','supabase-canonical-planner-production.sql','supabase-planner-ops.sql','supabase-planner-production-hardening.sql')
