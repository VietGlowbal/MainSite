...
function buildMarkdown(cluster: TopicCluster, generatedAt: string) {
  ...
  return fillTemplate(template, {
    ...
    methodology: `Glowbal ranked these options using a student-decision lens: course fit, total cost, scholarship realism, graduate outcome signals, and whether the university belongs in a reach, target, or safer shortlist for ${cluster.studentSegment.toLowerCase()}.`,
