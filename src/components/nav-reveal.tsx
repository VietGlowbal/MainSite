...
function IconApply()        { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 3h6"/><path d="M10 12l2 2 4-4"/><rect x="5" y="3" width="14" height="18" rx="2"/><path d="M9 17h6"/></svg>; }
function IconScholarship()  { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3 2 7l10 4 10-4-10-4z"/><path d="M6 10.5V15c0 1.7 2.7 3 6 3s6-1.3 6-3v-4.5"/><path d="M10 12.8v4.4"/><path d="M14 12.8v4.4"/></svg>; }
function IconMentorship()   { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 12h3l2 2 3-3 4 4"/><path d="M18 3h3v3"/><path d="M3 21v-4a2 2 0 0 1 2-2h4"/><circle cx="8" cy="8" r="3"/></svg>; }
