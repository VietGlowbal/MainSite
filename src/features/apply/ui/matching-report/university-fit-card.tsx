...
export function UniversityFitCard({
  ...
  const defaultInsight =
    insightSummary ||
    t(
      'You demonstrate a well-rounded profile with strong academic readiness and a clear sense of purpose. Universities in your target tier will see you as a candidate who can contribute meaningfully to their community.',
    );
  ...
  return (
    <div className="flex flex-col gap-gb-xl rounded-gb-2xl border border-line bg-surface p-gb-2xl shadow-xs">
      <div className="grid grid-cols-1 gap-gb-2xl lg:grid-cols-12 lg:items-stretch">
        ...
        <div className="flex flex-col items-center justify-between border-b border-line/60 pb-gb-xl text-center lg:col-span-3 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-gb-xl">
        ...
        <div className="flex flex-col justify-between border-b border-line/60 pb-gb-xl lg:col-span-5 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-gb-xl">
          <div className="flex flex-col gap-gb-2xs">
            ...
            <p className="text-gb-xs leading-relaxed text-fg-tertiary">
              {t(
                'Your profile shows strong alignment across the key dimensions universities consider when evaluating candidates.',
              )}
            </p>
          </div>
          ...
          <div className="mt-gb-md flex flex-col gap-gb-md">
            {dimensions.map((dim) => (
              <div
                key={dim.id}
                className="flex items-center justify-between gap-gb-sm py-gb-2xs"
              >
