...
export const translations: Record<string, string> = {
  ...
  "Find the university that's right for you": 'Tìm ngôi trường phù hợp với bạn',
  'Explore 10,000+ universities worldwide and find your perfect fit.':
    'Khám phá hơn 10.000 trường đại học trên toàn thế giới và tìm nơi phù hợp nhất với bạn.',
  ...
  'Refine your search': 'Tinh chỉnh tìm kiếm',
