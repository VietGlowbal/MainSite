...
export const translations: Record<string, string> = {
  ...
  'Giải thưởng học thuật': 'Giải thưởng học thuật',
  'Học bổng': 'Học bổng',
  'Nghiên cứu khoa học / Bài báo được xuất bản': 'Nghiên cứu khoa học / Bài báo được xuất bản',
  'Bằng khen / Giấy khen': 'Bằng khen / Giấy khen',
  'Scholarship / Grant': 'Học bổng',
  'Published Research / Paper': 'Nghiên cứu khoa học / Bài báo được xuất bản',
  'Certificate of Merit / Commendation': 'Bằng khen / Giấy khen',
  'If you don’t have a CV yet, you can manually enter your achievements below.': 'Nếu chưa có CV có thể tự nhập thông tin ở dưới',
  'Upload your CV or certificate PDFs and we’ll automatically extract your achievements.': 'Tải tệp CV hoặc chứng chỉ của bạn lên, hệ thống sẽ tự động trích xuất các thành tích.',
  ...
  'Upload supporting evidence (if any)': 'Tải minh chứng đính kèm (nếu có)',
  ...
  'e.g. Youth Union / Student Association': 'vd: Đoàn trường THPT',
  'e.g. Project Lead / Vice President': 'vd: Trưởng ban Tổ chức',
  'e.g. 06/2024 – 08/2024 or 2024 – 2025': 'vd: 06/2024 - 08/2024',
