...
export const translations: Record<string, string> = {
  ...
  // Candidate Information — Reflection Form (SVG / Figma Mockup)
  'Academic achievements and non-academic activities': 'Thành tích học thuật và hoạt động phi học thuật',
  'Achievement {index}': 'Thành tích {index}',
  'Academic category': 'Loại thành tích học thuật',
  'Competition / Award name': 'Tên cuộc thi / Giải thưởng',
  'Organizing institution': 'Đơn vị tổ chức',
  'Year achieved': 'Năm đạt',
  'National / Country': 'Toàn quốc / Quốc gia',
  'City / Province': 'Tỉnh / Thành phố',
  'Regional': 'Khu vực',
  'Community': 'Cộng đồng',
  'Academic awards & prizes': 'Giải thưởng học thuật',
  'Certificates of Merit': 'Bằng khen / Giấy khen',
  'Volunteering / Community Project (core role, measurable impact)': 'Hoạt động tình nguyện / Dự án cộng đồng (vai trò cốt lõi, tác động đo lường được)',
  'Club / Team Leadership (President, Lead, Founder for 6+ months)': 'Lãnh đạo CLB / Đội nhóm (Chủ tịch, Trưởng ban, Founder dự án... từ 6 tháng trở lên)',
  'Personal Projects / Entrepreneurship / Social Initiatives': 'Dự án cá nhân / Khởi nghiệp / Sáng kiến xã hội (tạo ra sản phẩm, dịch vụ hoặc phong trào cụ thể)',
  'Internship / Company / NGO Project (minimum 1-2 months)': 'Thực tập / Dự án tại Doanh nghiệp / Tổ chức phi chính phủ (tối thiểu 1-2 tháng)',
  'Mentoring / Tutoring (at least 3-6 months)': 'Cố vấn / Dạy kèm học sinh (ít nhất 3-6 tháng)',
  'Non-academic activities': 'Hoạt động phi học thuật',
  'Activity {index}': 'Hoạt động {index}',
  'Non-academic activity type': 'Loại hoạt động phi học thuật',
  'Activity note on core role': 'Hoạt động chỉ tham gia đơn thuần (thành viên thông thường) có thể ghi ngắn gọn hoặc không đưa vào để ưu tiên các hoạt động có vai trò nổi bật.',
  'Position / Role': 'Vị trí',
  'Organization / Project name': 'Tên tổ chức/Dự án',
  'Time period': 'Thời gian',
  'Additional details': 'Bổ sung thông tin chi tiết',
  'or drag and drop here (PDF, DOCX, max 10MB)': 'hoặc kéo thả vào đây (PDF, DOCX, tối đa 10MB)',
  'Analyzing and automatically extracting achievements...': 'Đang phân tích và tự động trích xuất thành tích...',
  'Remove file': 'Xóa tệp',
  'Remove this card': 'Xóa thẻ này',
  'No matching options': 'Không có tùy chọn phù hợp',
  'Help / Instructions': 'Hướng dẫn điền thông tin',
  'Instructions for filling information': 'Hướng dẫn điền thông tin',
  'You can upload your CV (PDF, DOCX) to automatically extract your achievements and activities, or manually enter them below.': 'Bạn có thể tải lên tệp CV (PDF, DOCX) để hệ thống tự động nhận diện và điền nhanh các giải thưởng, dự án và hoạt động của bạn. Hoặc bạn có thể tự nhập tay từng thành tích vào các ô bên dưới.',
  'If you don’t have a CV yet, you can manually enter your achievements below.': 'Nếu chưa có CV có thể tự nhập thông tin ở dưới',
  'Supporting documents (certificates, publications) increase verification reliability when GlowBal crafts your application strategy.': 'Các minh chứng đính kèm (giấy khen, chứng chỉ, bài báo) sẽ giúp tăng độ tin cậy khi GlowBal xây dựng chiến lược ứng tuyển.',
  'Upload failed. Please try again.': 'Tải lên thất bại. Vui lòng thử lại.',
  'vd: 06/2024 - 08/2024': 'vd: 06/2024 - 08/2024',
  'e.g. First Prize, National Olympiad 2024': 'vd: Giải nhất Kì thi Olympic Toán học Sinh viên toàn quốc 2024',
  'e.g. National High School Contest': 'vd: Olympic Toán học Toàn quốc',
  'e.g. Vietnam Mathematical Society / VNU': 'vd: Hội Toán học Việt Nam / ĐHQG',
  'e.g. Green Summer Volunteer Campaign': 'vd: Chiến dịch Mùa hè xanh',
  'e.g. Project Lead / Head of Organizing Committee': 'vd: Trưởng ban Tổ chức',
  'e.g. Youth Union / High School': 'vd: Đoàn trường THPT',
  'e.g. 06/2024 – 08/2024': 'vd: 06/2024 - 08/2024',
  'Extracted': 'Đã trích xuất',
  'Extend all': 'Hiển thị thêm...',
  'Collapse': 'Thu gọn',
  'Search or select...': 'Tìm kiếm hoặc chọn...',
  'Supports: PDF, DOC, DOCX, PNG, JPG (Max 10MB)': 'Hỗ trợ tệp: PDF, DOC, DOCX, PNG, JPG (Tối đa 10MB)',
  'Supports: PDF, DOC, DOCX (Max 10MB)': 'Hỗ trợ tệp: PDF, DOC, DOCX (Tối đa 10MB)',
  'e.g. First Prize, National Mathematics Olympiad': 'vd: Giải nhất Kì thi Olympic Toán học Sinh viên toàn quốc 2024',
  'e.g. Ministry of Education and Training': 'vd: Hội Toán học Việt Nam / ĐHQG',
  'Select year': 'Chọn năm',
  'Select level': 'Chọn cấp độ',
  'Describe your scores, ranks, scope, or key contributions...': 'Điểm số đạt được: 28.5/30, xếp thứ 2 toàn đoàn. Đại diện cho trường...',
  'Remove this achievement': 'Xóa thành tích này',
  'Describe your role, responsibilities, project outcomes, or community impact...': 'Điều phối 50 tình nguyện viên tham gia xây dựng 2 phòng học cho trẻ em vùng cao...',
  'Remove this activity': 'Xóa hoạt động này',
  'Failed to extract achievements': 'Không thể trích xuất thành tích',
  'Invalid response from extraction service': 'Phản hồi từ dịch vụ trích xuất không hợp lệ',
  'Upload failed': 'Tải lên thất bại',
  'Could not save achievements. Please try again.': 'Không thể lưu thành tích. Vui lòng thử lại.',
  /*
  ...
  // ── Crawled Static UI Labels & Chrome Additions ──────────────────────────
  ". Click it to activate your account and pick up where you left off.": ". Nhấp vào liên kết để kích hoạt tài khoản và tiếp tục từ nơi bạn đã dừng lại.",
  "Access code": "Mã truy cập",
  "Enter access code": "Nhập mã truy cập",
  "Invalid access code. Please check and try again.": "Mã truy cập không hợp lệ. Vui lòng kiểm tra và thử lại.",
  "Check your email": "Kiểm tra email của bạn",
  "We sent a magic sign-in link to": "Chúng tôi đã gửi một liên kết đăng nhập đến",
  "Did not receive it? Check your spam folder or": "Chưa nhận được? Kiểm tra thư mục spam hoặc",
  "Send another link": "Gửi liên kết khác",
  "Sending link...": "Đang gửi liên kết...",
  "Sign in with Google": "Đăng nhập với Google",
  "Sign in with Email": "Đăng nhập với Email",
  "Enter your email address": "Nhập địa chỉ email của bạn",
  "Continue with email": "Tiếp tục với email",
  "By continuing, you agree to our Terms of Service and Privacy Policy.": "Bằng cách tiếp tục, bạn đồng ý với Điều khoản dịch vụ và Chính sách bảo mật của chúng tôi.",
  "Welcome to GlowBal": "Chào mừng đến với GlowBal",
  "Let’s set up your profile to give you personalized recommendations": "Hãy thiết lập hồ sơ để nhận các đề xuất cá nhân hóa cho bạn",
  "Where are you dreaming of studying?": "Bạn đang mơ ước du học ở đâu?",
  "Select countries you are interested in": "Chọn các quốc gia bạn quan tâm",
  "Select your current academic stage": "Chọn giai đoạn học tập hiện tại của bạn",
  "High School": "Trung học Phổ thông",
  "Master’s / Postgraduate": "Thạc sĩ / Sau đại học",
  "Working Professional": "Người đã đi làm",
  "Complete setup": "Hoàn tất thiết lập",
  "You’re all set!": "Tất cả đã sẵn sàng!",
  "Go to Strategy Master": "Đi đến Strategy Master",
  "Document upload": "Tải lên tài liệu",
  "Upload transcripts, test certificates, and draft essays so GlowBal AI can give you sharper feedback.": "Tải lên bảng điểm, chứng chỉ bài thi và bản thảo bài luận để GlowBal AI đưa ra nhận xét sắc bén hơn.",
  "Continue to Strategy Master": "Tiếp tục đến Strategy Master",
  "Your education history, grades and subjects.": "Lịch sử học tập, điểm số và các môn học của bạn.",
  "Your English-language and standardized test results.": "Kết quả bài thi tiếng Anh và các bài thi chuẩn hóa của bạn.",
  "Your name, nationality, location and contact details.": "Họ tên, quốc tịch, nơi ở và thông tin liên hệ của bạn.",
  "Where and what you want to study, your budget, and the support you need.": "Địa điểm, ngành học bạn mong muốn, ngân sách và hỗ trợ bạn cần.",
  "What you want to achieve through higher education and your dream career path.": "Mục tiêu bạn muốn đạt được qua đại học và định hướng sự nghiệp mơ ước.",
  "Upload your CV, personal statement, transcripts and other supporting documents.": "Tải lên CV, bài luận cá nhân, bảng điểm và các tài liệu bổ trợ khác.",
  "Written in your own words. This is the part an advisor reads first.": "Viết theo lời văn của riêng bạn. Đây là phần cố vấn sẽ đọc đầu tiên.",
  "Where you want support most": "Nơi bạn cần hỗ trợ nhiều nhất",
  "Your skills": "Kỹ năng của bạn",
  "Add a valid grade for every selected curriculum before saving.": "Thêm điểm số hợp lệ cho mỗi chương trình học đã chọn trước khi lưu.",
  "Add every result you have. An expired score still helps us judge your level.": "Thêm tất cả kết quả bạn có. Điểm đã hết hạn vẫn giúp chúng tôi đánh giá năng lực của bạn.",
  "Year": "Năm",
  "Month": "Tháng",
  "School name": "Tên trường",
  "Current school or university": "Trường học hoặc đại học hiện tại",
  "Degree or grade level": "Bậc học hoặc khối lớp",
  "Current qualification": "Bằng cấp hiện tại",
  "Major or study track": "Chuyên ngành hoặc khối học",
  "Overall GPA / score": "Điểm GPA / điểm tổng kết",
  "Graduation year": "Năm tốt nghiệp",
  "Expected graduation": "Dự kiến tốt nghiệp",
  "Target study destination": "Điểm đến du học mong muốn",
  "Target degree level": "Bậc học mong muốn",
  "Intended intake": "Kỳ nhập học dự kiến",
  "Target intake year": "Năm nhập học dự kiến",
  "Target major / field": "Ngành / lĩnh vực học mục tiêu",
  "Secondary target major": "Ngành học mục tiêu phụ",
  "Target subjects": "Các môn học trọng tâm",
  "Select target subjects": "Chọn các môn học trọng tâm",
  "Add subject": "Thêm môn học",
  "Remove subject": "Xóa môn học",
  "English proficiency test": "Bài thi năng lực tiếng Anh",
  "Test score": "Điểm bài thi",
  "Test date": "Ngày thi",
  "Planning to take": "Dự định thi",
  "Not taken yet": "Chưa thi",
  "Overall band / score": "Điểm tổng / band điểm",
  "Listening score": "Điểm Nghe",
  "Reading score": "Điểm Đọc",
  "Writing score": "Điểm Viết",
  "Speaking score": "Điểm Nói",
  "SAT score": "Điểm SAT",
  "ACT score": "Điểm ACT",
  "GRE score": "Điểm GRE",
  ...
  "Currently working here": "Hiện đang làm việc tại đây",
  "Currently active": "Hiện đang hoạt động",
  "Description and achievements": "Mô tả và thành tích",
  "Key responsibilities and impact": "Trách nhiệm chính và kết quả đạt được",
  "Honors and awards": "Giải thưởng và danh hiệu",
  "Add honor or award": "Thêm giải thưởng / danh hiệu",
  "Award title": "Tên giải thưởng",
  "Issuing organization": "Đơn vị trao giải",
  "Scope / Level": "Quy mô / Cấp độ",
  "International": "Quốc tế",
  "National": "Quốc gia",
  "Regional / City": "Cấp tỉnh / thành phố",
  "Short-term career goals": "Mục tiêu nghề nghiệp ngắn hạn",
  "Long-term vision": "Tầm nhìn dài hạn",
  "Why do you want to study this field?": "Tại sao bạn muốn học ngành này?",
  "Budget per year": "Ngân sách mỗi năm",
  "Estimated annual budget (USD)": "Ngân sách ước tính hàng năm (USD)",
  "Financial aid / scholarship need": "Nhu cầu hỗ trợ tài chính / học bổng",
  "Need full scholarship": "Cần học bổng toàn phần",
  "Need partial scholarship": "Cần học bổng bán phần",
  "Self-funded": "Tự túc học phí",
  "Preferred campus environment": "Môi trường học tập mong muốn",
  "Preferred climate": "Khí hậu ưa thích",
  "Warm": "Ấm áp",
  "Cold / Temperate": "Ôn đới / Lạnh",
  "No preference": "Không có ưu tiên đặc biệt",
  "Certificate": "Chứng chỉ",
  "Personal Statement / Essay": "Bài luận cá nhân",
  "Recommendation Letter": "Thư giới thiệu",
  "Passport / ID": "Hộ chiếu / CCCD",
  "Other document": "Tài liệu khác",
  "Choose a file": "Chọn tệp",
  "Drag & drop your file here, or browse": "Kéo & thả tệp vào đây, hoặc duyệt tệp",
  "Supported formats: PDF, DOC, DOCX, PNG, JPG (up to 10MB)": "Định dạng hỗ trợ: PDF, DOC, DOCX, PNG, JPG (tối đa 10MB)",
  ...
  "· keep going": "· tiếp tục",
  "A modern green campus 15 km from central Hanoi — Vietnam’s growing innovation belt.": "Khuôn viên xanh hiện đại cách trung tâm Hà Nội 15 km — vành đai đổi mới sáng tạo đang phát triển của Việt Nam.",
  "University fit": "Mức độ phù hợp với trường",
  "Why this university matches": "Vì sao trường này phù hợp",
  "Watch out for": "Điểm cần lưu ý",
  "University recommendations compare your profile with the university strengths and fit signals available today.": "Đề xuất đại học so sánh hồ sơ của bạn với thế mạnh và các tiêu chí phù hợp của trường hiện có.",
  "View universities": "Xem các trường đại học",
  "VinUni evaluates every applicant on four pillars — Ability, Aspirations, Creativity, Commitment. See how your Statement of Purpose stacks up.": "VinUni đánh giá ứng viên dựa trên 4 trụ cột — Năng lực, Khát vọng, Sáng tạo, Cam kết (AACC). Hãy xem bài luận của bạn đạt mức nào.",
  "VinUni evaluates holistically — academics, English proficiency, leadership and fit.": "VinUni đánh giá toàn diện — học thuật, trình độ tiếng Anh, năng lực lãnh đạo và độ phù hợp.",
  "VinUni partners directly with global employers and Ivy League graduate schools.": "VinUni hợp tác trực tiếp với các nhà tuyển dụng toàn cầu và các trường sau đại học thuộc Ivy League.",
  "Year-1 housing": "Ký túc xá năm nhất",
  "Tuition & Fees": "Học phí & Chi phí",
  "Admission Requirements": "Yêu cầu Tuyển sinh",
  "Scholarship Opportunities": "Cơ hội Học bổng",
  "Career Outcomes": "Đầu ra Sự nghiệp",
  "World Ranking": "Xếp hạng Thế giới",
  "Average Cost of Living": "Chi phí Sinh hoạt Trung bình",
  "Programs Offered": "Các Chương trình Đào tạo",
  "Explore programs": "Khám phá các chương trình học",
  "Filter by country": "Lọc theo quốc gia",
  "Filter by major": "Lọc theo ngành học",
  "Filter by ranking": "Lọc theo xếp hạng",
  "Reset filters": "Đặt lại bộ lọc",
  "No universities found matching your criteria.": "Không tìm thấy trường đại học nào khớp với tiêu chí của bạn.",
  "Try adjusting your search or filters to see more results.": "Hãy thử điều chỉnh tìm kiếm hoặc bộ lọc để xem thêm kết quả.",
  "A short walkthrough of how GlowBal takes you from a dream university to a clear scholarship plan.": "Một video ngắn hướng dẫn cách GlowBal giúp bạn đi từ mục tiêu trường học đến một lộ trình săn học bổng rõ ràng.",
  "A missing dimension must use a null score.": "Tiêu chí còn thiếu phải để điểm trống (null).",
  "Admissions Competency Framework": "Khung Năng lực Tuyển sinh",
  "Admissions criteria": "Tiêu chí tuyển sinh",
  "Admissions readiness": "Mức độ sẵn sàng tuyển sinh",
  "Advanced advisor matching": "Kết nối cố vấn chuyên sâu",
  "Your essay": "Bài luận của bạn",
  "Your recommendation letter": "Thư giới thiệu của bạn",
  "View full AACC analysis": "Xem phân tích AACC đầy đủ",
  "View full analysis": "Xem phân tích đầy đủ",
  "Upload evidence": "Tải lên minh chứng",
  "Words": "Từ",
  "We do not have enough of your target profile or CV content yet to recommend a layout, so this is a general-purpose default.": "Chưa có đủ thông tin hồ sơ mục tiêu hoặc nội dung CV để gợi ý bố cục, đây là bố cục mặc định đa dụng.",
  "Vagueness Gate": "Đánh giá độ cụ thể (Vagueness Gate)",
  "Personal Statement Builder": "Công cụ Xây dựng Bài luận Cá nhân",
  "CV Builder": "Công cụ Xây dựng CV",
  "LOR Builder": "Công cụ Xây dựng Thư Giới thiệu",
  "Strategic Positioning": "Định vị Chiến lược",
  "CV Content": "Nội dung CV",
  "CV Layout": "Bố cục CV",
  "CV Review": "Đánh giá CV",
  "Generate CV": "Tạo CV",
  "Regenerate CV": "Tạo lại CV",
  "Download CV": "Tải xuống CV",
  "Strengths identified": "Thế mạnh được ghi nhận",
  "Areas to improve": "Điểm cần cải thiện",
  "Suggested revisions": "Đề xuất chỉnh sửa",
  "Pillar score": "Điểm trụ cột",
  "Ability": "Năng lực (Ability)",
  "Holistic evaluation": "Đánh giá toàn diện",
  "Storytelling angle": "Góc kể chuyện",
  "Key narratives": "Thông điệp then chốt",
  "Actionable suggestions": "Gợi ý hành động cụ thể",
  "Scholarship search": "Tìm kiếm học bổng",
  "Coverage type": "Mức độ hỗ trợ",
  "Partial tuition": "Học phí bán phần",
  "Living stipend included": "Bao gồm sinh hoạt phí",
  "Eligible nationalities": "Quốc tịch đủ điều kiện",
  "Save scholarship": "Lưu học bổng",
  "Saved to your portal": "Đã lưu vào trang lưu của bạn",
  "Total earned": "Tổng thu nhập",
  "Select date & time": "Chọn ngày & giờ",
  "Session duration": "Thời lượng buổi tư vấn",
  "30 minutes": "30 phút",
  "45 minutes": "45 phút",
  "60 minutes": "60 phút",
  "Help topics": "Chủ đề hỗ trợ",
  "Mentorship areas": "Lĩnh vực cố vấn",
  "What do you need help with?": "Bạn cần hỗ trợ điều gì?",
  "Provide details so your mentor can prepare effectively for the session.": "Cung cấp thông tin chi tiết để cố vấn chuẩn bị chu đáo nhất cho buổi trao đổi.",
  "Confirm booking": "Xác nhận đặt lịch",
  "Booking confirmed": "Đặt lịch thành công",
  "We’ve emailed you and your advisor with the meeting link and calendar invite. You can also see it below.": "Chúng tôi đã gửi email kèm link cuộc họp và lời mời lịch cho bạn và cố vấn. Bạn cũng có thể xem bên dưới.",
  "Your session is confirmed. The meeting link is in your email and on the card below.": "Buổi tư vấn của bạn đã được xác nhận. Link cuộc họp có trong email và trên thẻ bên dưới.",
  "Available slots": "Khung giờ còn trống",
  "No available slots for this date": "Không có khung giờ trống trong ngày này",
  "Next available date": "Ngày trống tiếp theo",
  "About the advisor": "Về cố vấn",
  "Mentoring experience": "Kinh nghiệm cố vấn",
  "Student reviews": "Đánh giá từ học sinh",
  "Verified mentor": "Cố vấn đã xác thực",
  "Trying again…": "Đang thử lại…",
  "Application checklist": "Danh mục hồ sơ ứng tuyển",
  "Track application": "Theo dõi hồ sơ",
  "Add to application list": "Thêm vào danh sách ứng tuyển",
  "Remove from list": "Xóa khỏi danh sách",
  "Task status": "Trạng thái nhiệm vụ",
  "In progress": "Đang thực hiện",
  "Under review": "Đang xem xét",
  "Target submission date": "Ngày dự kiến nộp",
  "Application fee": "Phí nộp hồ sơ",
  "Portal login": "Đăng nhập cổng trường",
  "Required essays": "Các bài luận bắt buộc",
  "Required recommendation letters": "Số lượng thư giới thiệu yêu cầu",
  "Official transcript needed": "Cần bảng điểm chính thức",
  "Financial documentation needed": "Cần giấy tờ chứng minh tài chính",
  "Unlimited AI-powered course searches": "Tìm kiếm ngành học không giới hạn với AI",
  "Unlimited course applications": "Theo dõi không giới hạn hồ sơ ứng tuyển",
  "We don’t publish fake reviews. While the first student stories are on the way, here’s the advising track record behind GlowBal.": "Chúng tôi không đăng đánh giá ảo. Trong khi những câu chuyện học sinh đầu tiên đang được hoàn thiện, đây là kết quả tư vấn thực tế của đội ngũ GlowBal.",
  "We could not save that file. Please try again.": "Không thể lưu tệp đó. Vui lòng thử lại.",
  "Unsubscribe": "Hủy đăng ký",
  "Unsubscribing...": "Đang hủy đăng ký...",
  "Total visits": "Tổng lượt truy cập",
  "Total visits driven": "Tổng lượt truy cập mang lại",
  "Unique visitors": "Khách truy cập duy nhất",
  "Total sign-ups through links": "Tổng lượt đăng ký qua liên kết",
  "Commission earned": "Hoa hồng nhận được",
  "Referral link": "Liên kết giới thiệu",
  "Copy link": "Sao chép liên kết",
  "Link copied!": "Đã sao chép liên kết!",
  "Ambassador dashboard": "Bảng điều khiển đại sứ",
  "Active ambassadors": "Đại sứ đang hoạt động",
  "Be the first to know when we launch": "Trở thành người đầu tiên biết khi chúng tôi ra mắt",
  "Thank you for joining our waitlist!": "Cảm ơn bạn đã tham gia danh sách chờ của chúng tôi!",
  "{count} article(s)": "{count} bài viết",
  "{minutes} min read · formatting toolbar enabled": "{minutes} phút đọc · đã bật thanh công cụ định dạng",
  "A clear headline your reader can understand": "Tiêu đề rõ ràng giúp người đọc dễ hiểu",
  "A strong image gives the story a clear entry point.": "Một hình ảnh ấn tượng sẽ tạo điểm nhấn mở đầu cho bài viết.",
  "Add link": "Thêm liên kết",
  "Unpublish": "Gỡ bài xuất bản",
  "Unsaved changes": "Thay đổi chưa lưu",
  "Untitled article": "Bài viết chưa có tiêu đề",
  "Update failed": "Cập nhật thất bại",
  "Update your story, then preview it before publishing.": "Cập nhật bài viết của bạn, sau đó xem trước trước khi xuất bản.",
  "Updated": "Đã cập nhật",
  "Upload an image": "Tải lên hình ảnh",
  "Upload image": "Tải ảnh lên",
  "Use the image button to upload an inline image. Add descriptive alt text in the image dialog.": "Sử dụng nút hình ảnh để tải ảnh vào bài viết. Thêm văn bản mô tả thay thế trong hộp thoại hình ảnh.",
  "Write an article": "Viết bài mới",
  "Write for people first. The public article will keep the same formatting.": "Hãy viết vì người đọc trước tiên. Bài viết công khai sẽ giữ nguyên định dạng này.",
  "Title is required": "Tiêu đề là bắt buộc",
  "Topic": "Chủ đề",
  "Article title": "Tiêu đề bài viết",
  "Article summary": "Tóm tắt bài viết",
  "Article slug": "Đường dẫn (slug) bài viết",
  "Cover image URL": "URL ảnh bìa",
  "Read time (minutes)": "Thời gian đọc (phút)",
  "Publish status": "Trạng thái xuất bản",
  "Draft": "Bản nháp",
  "Published": "Đã xuất bản",
  "Archived": "Đã lưu trữ",
  "Publish article": "Xuất bản bài viết",
  "Delete article": "Xóa bài viết",
  "Article deleted": "Đã xóa bài viết",
  "Article published": "Đã xuất bản bài viết",
  "Article saved as draft": "Đã lưu bài viết dưới dạng bản nháp",
  "Author name": "Tên tác giả",
  "Author title": "Chức danh tác giả",
  "User management": "Quản lý người dùng",
  "Coordinator management": "Quản lý điều phối viên",
  "Booking management": "Quản lý đặt lịch",
  "ACCEPTANCE OF TERMS": "CHẤP NHẬN ĐIỀU KHOẢN",
  "Account deferral does not extend the 24-hour refund eligibility window.": "Bảo lưu tài khoản không kéo dài thời hạn 24 giờ của chính sách hoàn tiền.",
  "ACCOUNT DEFERRAL POLICY": "CHÍNH SÁCH BẢO LƯU TÀI KHOẢN",
  "Achieve specific test scores or results;": "Đạt được điểm số hoặc kết quả thi cụ thể;",
  "Actual outcomes depend on multiple factors including individual student profile, competition level, institutional criteria, and official decisions.": "Kết quả thực tế phụ thuộc vào nhiều yếu tố bao gồm hồ sơ từng học sinh, mức độ cạnh tranh, tiêu chí tuyển sinh của từng trường và quyết định chính thức.",
  "THÔNG TIN LIÊN HỆ": "THÔNG TIN LIÊN HỆ",
  "TOÀN BỘ THỎA THUẬN": "TOÀN BỘ THỎA THUẬN",
  "TRÁCH NHIỆM CỦA NGƯỜI DÙNG": "TRÁCH NHIỆM CỦA NGƯỜI DÙNG",
  "TỪ BỎ QUYỀN": "TỪ BỎ QUYỀN",
  "USER RESPONSIBILITIES": "TRÁCH NHIỆM CỦA NGƯỜI DÙNG",
  "VAI TRÒ CỦA GLOWBAL": "VAI TRÒ CỦA GLOWBAL",
  "To the maximum extent permitted by applicable law, GlowBal shall not be liable for indirect, incidental, special, or consequential damages resulting from inability to use the Platform, third-party decisions, data inaccuracies, or third-party mentor actions.": "Trong phạm vi tối đa được pháp luật cho phép, GlowBal không chịu trách nhiệm đối với các thiệt hại gián tiếp, ngẫu nhiên, đặc biệt hoặc mang tính hệ quả phát sinh từ việc không thể sử dụng Nền tảng, quyết định của bên thứ ba, dữ liệu không chính xác hoặc hành vi của cố vấn bên thứ ba.",
  "Updated versions will be published on the Platform along with the latest revision date.": "Các phiên bản cập nhật sẽ được công bố trên Nền tảng kèm theo ngày sửa đổi mới nhất.",
  "Upon account termination, access rights cease immediately.": "Khi tài khoản bị chấm dứt, quyền truy cập sẽ chấm dứt ngay lập tức.",
  "Upon reactivation, GlowBal reserves the right to verify identity. If unauthorized transfer or fraud is found, the account will be permanently terminated.": "Khi kích hoạt lại, GlowBal có quyền xác minh danh tính. Nếu phát hiện chuyển nhượng trái phép hoặc gian lận, tài khoản sẽ bị chấm dứt vĩnh viễn.",
  "Users are responsible for independently checking and verifying all official institutional requirements before making decisions.": "Người dùng có trách nhiệm tự kiểm tra và xác minh độc lập tất cả các yêu cầu chính thức của trường trước khi đưa ra quyết định.",
  "Using Services unlawfully;": "Sử dụng Dịch vụ một cách trái pháp luật;",
  "Violating these Terms;": "Vi phạm các Điều khoản này;",
  "War and civil unrest;": "Chiến tranh và bất ổn dân sự;",
  "When registering or using the Services, the User confirms that:": "Khi đăng ký hoặc sử dụng Dịch vụ, Người dùng xác nhận rằng:",
  "When using the Services, the User agrees to:": "Khi sử dụng Dịch vụ, Người dùng đồng ý:",
  "All content, materials, AI algorithms, software, interface designs, logos, and trademarks on the Platform are the exclusive intellectual property of GlowBal or its licensors.": "Mọi nội dung, tài liệu, thuật toán AI, phần mềm, thiết kế giao diện, logo và nhãn hiệu trên Nền tảng đều là tài sản trí tuệ độc quyền của GlowBal hoặc bên cấp phép.",
  "APPLICABLE LAW AND DISPUTE RESOLUTION": "LUẬT ÁP DỤNG VÀ GIẢI QUYẾT TRANH CHẤP",
  "Authorize another person to use the account;": "Ủy quyền cho người khác sử dụng tài khoản;",
  "BẢO LƯU TÀI KHOẢN": "BẢO LƯU TÀI KHOẢN",
  "Be admitted to any educational institution;": "Được nhận vào bất kỳ cơ sở giáo dục nào;",
  "Carefully read, understand, and comply with these Terms;": "Đọc kỹ, hiểu và tuân thủ các Điều khoản này;",
  "CHẤP NHẬN ĐIỀU KHOẢN": "CHẤP NHẬN ĐIỀU KHOẢN",
  "CHÍNH SÁCH HOÀN TIỀN": "CHÍNH SÁCH HOÀN TIỀN",
  "CƠ CHẾ MIỄN TRỪ TRÁCH NHIỆM": "CƠ CHẾ MIỄN TRỪ TRÁCH NHIỆM",
  "Commercializing, copying, or reverse-engineering Services;": "Thương mại hóa, sao chép hoặc dịch ngược mã nguồn Dịch vụ;",
  "Comply with applicable laws and regulations;": "Tuân thủ các luật và quy định hiện hành;",
  "Cyberattacks, system interruptions, or data transmission failures beyond reasonable control;": "Tấn công mạng, gián đoạn hệ thống hoặc lỗi truyền dữ liệu nằm ngoài tầm kiểm soát hợp lý;",
  "Decisions, actions, or advice of mentors and third-party advisors;": "Quyết định, hành động hoặc lời khuyên của cố vấn và bên thứ ba;",
  "Deferral duration is up to 12 months from confirmation date.": "Thời gian bảo lưu tối đa là 12 tháng kể từ ngày xác nhận.",
  "Deferrals are non-transferable.": "Việc bảo lưu không được chuyển nhượng.",
  "DISCLAIMER OF WARRANTIES AND LIMITATION OF LIABILITY": "MIỄN TRỪ TRÁCH NHIỆM VÀ GIỚI HẠN NGHĨA VỤ",
  "ĐIỀU KIỆN SỬ DỤNG DỊCH VỤ": "ĐIỀU KIỆN SỬ DỤNG DỊCH VỤ",
  "Each user is permitted one deferral request per purchased Service.": "Mỗi người dùng được yêu cầu bảo lưu một lần cho mỗi Dịch vụ đã mua.",
  "Failure of students to achieve admission or scholarship goals;": "Việc học sinh không đạt được mục tiêu nhập học hoặc học bổng;",
  "Force majeure events;": "Các sự kiện bất khả kháng;",
  "GIỚI HẠN TRÁCH NHIỆM": "GIỚI HẠN TRÁCH NHIỆM",
  "GLOWBAL’S ROLE AND SERVICES": "VAI TRÒ VÀ DỊCH VỤ CỦA GLOWBAL",
  "GlowBal acts as an informational, advisory, and planning platform supporting study-abroad preparation. GlowBal is not an official admissions representative of any university, does not make admission decisions, and does not guarantee results.": "GlowBal đóng vai trò là nền tảng thông tin, tư vấn và lập kế hoạch hỗ trợ chuẩn bị du học. GlowBal không phải là đại diện tuyển sinh chính thức của bất kỳ trường nào, không đưa ra quyết định tuyển sinh và không đảm bảo kết quả.",
  "GlowBal does NOT guarantee that students will:": "GlowBal KHÔNG đảm bảo rằng học sinh sẽ:",
  "GlowBal is not liable for indirect or consequential damages.": "GlowBal không chịu trách nhiệm đối với các thiệt hại gián tiếp hoặc mang tính hệ quả.",
  "GlowBal operates as a study-abroad guidance and strategy planning platform. GlowBal is NOT an admissions authority, agent, or representative of any educational institution.": "GlowBal vận hành như một nền tảng định hướng và lập chiến lược du học. GlowBal KHÔNG phải là cơ quan tuyển sinh, đại lý hoặc đại diện của bất kỳ cơ sở giáo dục nào.",
  "GlowBal reserves the right to suspend or terminate accounts that violate these Terms.": "GlowBal có quyền tạm ngừng hoặc chấm dứt tài khoản vi phạm các Điều khoản này.",
  "GlowBal reserves the right to update these Terms at any time. Material changes will be notified via email or Platform announcement at least 15 days in advance.": "GlowBal có quyền cập nhật các Điều khoản này bất kỳ lúc nào. Các thay đổi quan trọng sẽ được thông báo qua email hoặc trên Nền tảng trước ít nhất 15 ngày.",
  "GlowBal will review and respond within 03 to 05 business days. Approved refunds will be processed via original payment method within 07 to 14 business days.": "GlowBal sẽ xem xét và phản hồi trong vòng 03 đến 05 ngày làm việc. Các khoản hoàn tiền được duyệt sẽ được xử lý qua phương thức thanh toán ban đầu trong vòng 07 đến 14 ngày làm việc.",
  "Harm the reputation or operations of GlowBal;": "Làm tổn hại danh tiếng hoặc hoạt động của GlowBal;",
  "If any provision is held invalid or unenforceable, remaining provisions remain in full force.": "Nếu bất kỳ điều khoản nào bị coi là vô hiệu hoặc không thể thi hành, các điều khoản còn lại vẫn giữ nguyên hiệu lực.",
  "If you have questions about these Terms, contact:": "Nếu bạn có thắc mắc về các Điều khoản này, vui lòng liên hệ:",
  "Inaccuracies in third-party information;": "Thông tin không chính xác từ bên thứ ba;",
  "Intellectual Property Infringement;": "Vi phạm quyền sở hữu trí tuệ;",
  "INTELLECTUAL PROPERTY RIGHTS": "QUYỀN SỞ HỮU TRÍ TUỆ",
  "Maintain the security and confidentiality of account credentials;": "Duy trì tính bảo mật của thông tin đăng nhập tài khoản;",
  "Make payments in accordance with agreed terms;": "Thanh toán đúng theo các điều khoản đã thỏa thuận;",
  "MODIFICATIONS TO TERMS": "SỬA ĐỔI ĐIỀU KHOẢN",
  "Natural disasters, epidemics, extreme weather;": "Thiên tai, dịch bệnh, thời tiết khắc nghiệt;",
  "Neither party shall be liable for failure or delay resulting from Force Majeure events, including:": "Không bên nào phải chịu trách nhiệm về việc không thực hiện hoặc chậm trễ do sự kiện Bất khả kháng, bao gồm:",
  "No failure or delay in exercising any right under these Terms shall constitute a waiver of that right.": "Việc không thực hiện hoặc chậm trễ thực hiện bất kỳ quyền nào theo các Điều khoản này không cấu thành sự từ bỏ quyền đó.",
  "No refund is applicable after services have been accessed, mentor sessions conducted, or personalized reports generated.": "Không áp dụng hoàn tiền sau khi dịch vụ đã được truy cập, buổi tư vấn cố vấn đã diễn ra hoặc báo cáo cá nhân hóa đã được tạo.",
  "Obtain scholarships or financial aid;": "Nhận được học bổng hoặc hỗ trợ tài chính;",
  "Orders or interventions by government authorities;": "Mệnh lệnh hoặc sự can thiệp của cơ quan chính phủ;",
  "Provide complete, accurate, and truthful information during registration and use;": "Cung cấp thông tin đầy đủ, chính xác và trung thực khi đăng ký và sử dụng;",
  "Provide false, misleading, or deceptive information;": "Cung cấp thông tin sai lệch, gây hiểu lầm hoặc lừa đảo;",
  "QUYỀN SỞ HỮU TRÍ TUỆ": "QUYỀN SỞ HỮU TRÍ TUỆ",
  "Receive a visa or entry permit to any country.": "Nhận được thị thực (visa) hoặc giấy phép nhập cảnh vào bất kỳ quốc gia nào.",
  "REFUND POLICY": "CHÍNH SÁCH HOÀN TIỀN",
  "Register with inaccurate information;": "Đăng ký với thông tin không chính xác;",
  "SEVERABILITY": "TÍNH ĐỘC LẬP CỦA ĐIỀU KHOẢN",
  "Share account access with third parties;": "Chia sẻ quyền truy cập tài khoản cho bên thứ ba;",
  "Single deferral per service": "Một lần bảo lưu duy nhất cho mỗi dịch vụ",
  "Submitting forged credentials;": "Nộp bằng cấp hoặc giấy tờ giả mạo;",
  "SUSPENSION AND TERMINATION": "TẠM NGỪNG VÀ CHẤM DỨT TÀI KHOẢN",
  "Take personal responsibility for meeting application deadlines;": "Tự chịu trách nhiệm cá nhân về việc đáp ứng các hạn chót nộp hồ sơ;",
  "TẠM NGỪNG VÀ CHẤM DỨT TÀI KHOẢN": "TẠM NGỪNG VÀ CHẤM DỨT TÀI KHOẢN",
  "Technical failures;": "Sự cố kỹ thuật;",
  "TERMS AND CONDITIONS OF USE": "ĐIỀU KHOẢN VÀ ĐIỀU KIỆN SỬ DỤNG",
  "THAY ĐỔI ĐIỀU KHOẢN": "THAY ĐỔI ĐIỀU KHOẢN",
  "The request must include: Full Name; Account Email; Service Name; Payment Date & Amount; Transaction ID; Reason for request.": "Yêu cầu phải bao gồm: Họ và tên; Email tài khoản; Tên dịch vụ; Ngày & Số tiền thanh toán; Mã giao dịch; Lý do yêu cầu.",
  "The User acknowledges and agrees that:": "Người dùng thừa nhận và đồng ý rằng:",
  "These Terms are governed by and construed in accordance with the laws of the Socialist Republic of Vietnam.": "Các Điều khoản này được điều chỉnh và giải thích theo pháp luật của Nước Cộng hòa Xã hội Chủ nghĩa Việt Nam.",
  "These Terms together with the Privacy Policy and other official notices constitute the entire agreement between the User and GlowBal regarding the Platform and Services.": "Các Điều khoản này cùng với Chính sách Bảo mật và các thông báo chính thức khác tạo thành toàn bộ thỏa thuận giữa Người dùng và GlowBal liên quan đến Nền tảng và Dịch vụ.",
  "They are at least 16 years of age;": "Đủ từ 16 tuổi trở lên;",
  "They possess legal capacity to accept and execute these Terms;": "Có đầy đủ năng lực pháp lý để chấp nhận và thực hiện các Điều khoản này;",
  "They provide accurate, complete, and truthful information;": "Cung cấp thông tin chính xác, đầy đủ và trung thực;",
  "They take full responsibility for activities under their account.": "Chịu hoàn toàn trách nhiệm về mọi hoạt động dưới tài khoản của mình.",
  "They use the Services for lawful purposes;": "Sử dụng Dịch vụ cho các mục đích hợp pháp;",
  "Third-party infrastructure outages;": "Sự cố gián đoạn hạ tầng của bên thứ ba;",
  "Timeframe:": "Thời hạn:",
  "with subject": "với tiêu đề",
  "Search articles by title, topic, or keyword...": "Tìm kiếm bài viết theo tiêu đề, chủ đề hoặc từ khóa...",
  "Search coordinators": "Tìm kiếm điều phối viên",
  "Search users": "Tìm kiếm người dùng",
  "Search users to make coordinator": "Tìm người dùng để phân quyền điều phối viên",
  "Separate tags with commas.": "Phân cách các thẻ tag bằng dấu phẩy.",
  "Show technical metadata": "Hiển thị dữ liệu kỹ thuật",
  ...
  "The article body could not be read. Review it before saving.": "Không thể đọc nội dung bài viết. Vui lòng kiểm tra lại trước khi lưu.",
  "The image must be 10 MB or smaller.": "Hình ảnh phải có dung lượng từ 10 MB trở xuống.",
  "The one idea readers should remember.": "Thông điệp cốt lõi người đọc cần ghi nhớ.",
  "These details help readers find and trust the story.": "Các thông tin này giúp người đọc tìm thấy và tin tưởng bài viết.",
  "UK, Computer Science": "Vương quốc Anh, Khoa học Máy tính",
  "URL": "Đường dẫn liên kết (URL)",
  "Upload an image to embed it in the story. PNG, JPG, or WebP up to 10 MB.": "Tải lên hình ảnh để chèn vào bài viết. Hỗ trợ PNG, JPG hoặc WebP tối đa 10 MB.",
  "Uploading image...": "Đang tải ảnh lên...",
  "URL is required": "Đường dẫn liên kết là bắt buộc",
  "View live article": "Xem bài viết trực tiếp",
  "View live article on the public site": "Xem bài viết trực tiếp trên trang công khai",
  "Visual Markdown": "Soạn thảo trực quan Markdown",
  "Weak": "Yếu",
  "Which country or study track this story belongs to.": "Quốc gia hoặc khối ngành học mà bài viết này đề cập đến.",
  "Write your article content here using Markdown...": "Viết nội dung bài viết của bạn tại đây bằng Markdown...",
  "Image description (alt text)": "Mô tả hình ảnh (alt text)",
  "Image title (optional)": "Tiêu đề hình ảnh (tùy chọn)",
  ...
  "Role": "Vai trò",
  "Make coordinator": "Chỉ định điều phối viên",
  "Remove coordinator": "Hủy quyền điều phối viên",
  "Are you sure you want to remove this coordinator?": "Bạn có chắc chắn muốn hủy quyền điều phối viên này?",
  "Showing": "Đang hiển thị",
  "users": "người dùng",
  "coordinators": "điều phối viên",
  "bookings": "lượt đặt lịch",
  "achievers": "gương mặt xuất sắc",
  "No bookings found.": "Không tìm thấy lượt đặt lịch nào.",
  "No coordinators found.": "Không tìm thấy điều phối viên nào.",
  "No users found.": "Không tìm thấy người dùng nào.",
  "Session": "Buổi tư vấn",
  "Mentor": "Cố vấn",
  "Date & Time": "Ngày & Giờ",
  "Duration": "Thời lượng",
  "Meeting Link": "Link Cuộc họp",
  "Mark as completed": "Đánh dấu đã hoàn thành",
  "Mark as cancelled": "Đánh dấu đã hủy",
  "Short bio": "Giới thiệu ngắn gọn",
  "Short labels, not sentences. These appear on your profile as chips.": "Các nhãn ngắn gọn, không viết cả câu. Chúng sẽ xuất hiện dưới dạng thẻ trên hồ sơ của bạn.",
  "Stored privately. Only you and the AI that scores your applications can read them.": "Lưu trữ riêng tư. Chỉ bạn và hệ thống AI đánh giá hồ sơ mới có thể đọc được tài liệu này.",
  "Strong profile. Your matches and plans will be sharper for it.": "Hồ sơ mạnh. Các gợi ý trường và kế hoạch chiến lược sẽ được tối ưu sắc bén hơn.",
  "Submit review": "Gửi đánh giá",
  "Submitting...": "Đang gửi...",
  "Subscription": "Gói đăng ký",
  "Target subjects / fields": "Ngành / lĩnh vực học mục tiêu",
  "That file is over 10MB.": "Tệp vượt quá dung lượng 10MB.",
  "The shortlist and the tier list are built from these three lists.": "Danh sách rút gọn và phân nhóm trường được xây dựng từ ba danh sách này.",
  "These are the curriculum and scale-aware grades saved by your education-planning test.": "Đây là điểm số theo đúng thang đo và chương trình học đã lưu từ bài kiểm tra định hướng du học của bạn.",
  "This is the same answer used by your education-planning test.": "Đây là câu trả lời giống với bài kiểm tra định hướng du học của bạn.",
  "Showing these universities": "Đang hiển thị các trường đại học này",
  "Sign in to save VinUni": "Đăng nhập để lưu VinUni",
  "Sign up": "Đăng ký",
  "Signing out…": "Đang đăng xuất…",
  "Singapore": "Singapore",
  "Strength alignment": "Mức độ tương thích thế mạnh",
  "Strengthen your recommendation letter": "Tối ưu hóa thư giới thiệu của bạn",
  "Tap one or more future days, then add the times you're free to all of them at once. Slots tied to confirmed bookings are locked.": "Chạm vào một hoặc nhiều ngày tới, sau đó thêm khung giờ bạn rảnh cho tất cả ngày đó cùng lúc. Các khung giờ đã có lịch xác nhận sẽ bị khóa.",
  "Target profile": "Hồ sơ mục tiêu",
  "Thanks for your payment!": "Cảm ơn bạn đã thanh toán!",
  "The analysis came back in an unexpected shape. Please try again.": "Kết quả phân tích trả về không đúng định dạng. Vui lòng thử lại.",
  "This public demo uses a fixed student profile and university strengths to show deterministic university tiers.": "Bản demo công khai này sử dụng một hồ sơ học sinh mẫu và thế mạnh của trường để hiển thị các phân nhóm trường chính xác.",
  "The activities on file don't yet show a consistent behavioural sequence (what prompted you to start, your role, your method, and the outcome).": "Các hoạt động trong hồ sơ chưa thể hiện rõ chuỗi hành vi nhất quán (động lực bắt đầu, vai trò của bạn, phương pháp thực hiện và kết quả).",
  "Start with the document you already have, or create one from your Glowbal profile.": "Bắt đầu với tài liệu bạn đã có, hoặc tạo mới trực tiếp từ hồ sơ Glowbal của bạn.",
  "Show tips": "Hiển thị mẹo",
  "searches": "lượt tìm kiếm",
  "secondary": "thứ cấp / phụ",
  "Send": "Gửi",
  "Publish": "Xuất bản",
  "Qualification type": "Loại văn bằng / chương trình học",
  "Quick answers to the things students ask most before applying.": "Giải đáp nhanh những câu hỏi học sinh thường thắc mắc nhất trước khi nộp hồ sơ.",
  "QUYỀN RIÊNG TƯ VÀ BẢO VỆ DỮ LIỆU": "QUYỀN RIÊNG TƯ VÀ BẢO VỆ DỮ LIỆU",
  "Re-analyse now": "Phân tích lại ngay",
  "Re-analysing…": "Đang phân tích lại…",
  "Readiness": "Mức độ sẵn sàng",
  "Reading like an admissions officer…": "Đang đọc dưới góc nhìn của hội đồng tuyển sinh…",
  "Reading the course page": "Đang đọc trang thông tin ngành học",
  "Receive scholarship awards;": "Nhận được các suất học bổng;",
  "Recognises academic excellence among new international applicants.": "Ghi nhận thành tích học tập xuất sắc của các ứng viên quốc tế mới.",
  "Recommendation criteria": "Tiêu chí thư giới thiệu",
  "Recommendation readiness": "Mức độ sẵn sàng của thư giới thiệu",
  "Refrain from using fraudulent documents, certificates, or profiles;": "Không sử dụng giấy tờ, chứng chỉ hoặc hồ sơ giả mạo;",
  "Refund Rate:": "Tỷ lệ hoàn tiền:",
  "Refund requests must be submitted within 24 hours of payment. After this timeframe, refund requests are not accepted unless mandated by law.": "Yêu cầu hoàn tiền phải được gửi trong vòng 24 giờ kể từ khi thanh toán. Sau thời hạn này, yêu cầu hoàn tiền sẽ không được chấp nhận trừ khi pháp luật có quy định khác.",
  "Rejected by Founder": "Đã bị từ chối bởi Người sáng lập",
  "Related": "Liên quan",
  "Relation": "Mối quan hệ liên kết",
  "Remove admin": "Xóa quyền quản trị viên",
  "Report available": "Báo cáo đã sẵn sàng",
  "Request Process:": "Quy trình yêu cầu:",
  "Requests sent after 24 hours, unverified transactions, inaccurate details, fraudulent behavior, Terms violations, or purchases made through platforms with separate refund rules.": "Yêu cầu gửi sau 24 giờ, giao dịch chưa được xác minh, thông tin không chính xác, hành vi gian lận, vi phạm Điều khoản, hoặc giao dịch mua qua các nền tảng có quy định hoàn tiền riêng.",
  "Required before publishing.": "Bắt buộc trước khi xuất bản.",
  "Required for accessibility and publishing.": "Bắt buộc để hỗ trợ tiếp cận và xuất bản bài viết.",
  "Required on-campus": "Bắt buộc ở trong ký túc xá trường",
  "Reserve your spot": "Giữ chỗ của bạn",
  "Resume": "Tiếp tục",
  "Review bank transfers, confirm transactions, and track platform revenue.": "Kiểm tra chuyển khoản ngân hàng, xác nhận giao dịch và theo dõi doanh thu nền tảng.",
  "Review this part": "Xem lại phần này",
  "Reviewing the recommendation letter…": "Đang đánh giá thư giới thiệu…",
  "Revoke": "Thu hồi",
  "ROLE OF GLOWBAL": "VAI TRÒ CỦA GLOWBAL",
  "Same hub/cluster": "Cùng cụm / nhóm chủ đề",
  "SAT, ACT, AP, IB, A-Level, and GCSE / IGCSE results saved by your education-planning test.": "Kết quả SAT, ACT, AP, IB, A-Level, và GCSE / IGCSE đã lưu từ bài kiểm tra định hướng du học của bạn.",
  "Save & return to application": "Lưu & quay lại hồ sơ ứng tuyển",
  "Save a university and it goes to My Portal. That saved list is where every application starts — you never need to leave the platform to begin one.": "Lưu một trường đại học và trường sẽ xuất hiện trong Trang lưu của bạn. Danh sách đã lưu là nơi bắt đầu mọi bộ hồ sơ — bạn không cần phải rời nền tảng để bắt đầu.",
  "Save achievements & skills": "Lưu thành tích & kỹ năng",
  "Save experiences": "Lưu kinh nghiệm",
  "Save failed": "Lưu thất bại",
  "Save goals": "Lưu mục tiêu",
  "Save links": "Lưu liên kết",
  "Save preferences": "Lưu nguyện vọng",
  "Save pricing": "Lưu mức giá",
  "Save test scores": "Lưu điểm thi",
  "Save the draft first to add related articles.": "Lưu bản nháp trước để thêm các bài viết liên quan.",
  "Save VinUniversity": "Lưu VinUniversity",
  "Saved successfully.": "Đã lưu thành công.",
  "Saving": "Đang lưu",
  "Saving article": "Đang lưu bài viết",
  "scholarship": "học bổng",
  "scholarships": "học bổng",
  "Scholarships are listed against the university that offers them, with the detail that decides whether you are eligible.": "Học bổng được liệt kê tương ứng với trường đại học cấp, kèm thông tin chi tiết quyết định bạn có đủ điều kiện hay không.",
  "SCOPE OF SERVICES": "PHẠM VI DỊCH VỤ",
  "Search a user by name, email, or ID": "Tìm người dùng theo tên, email hoặc ID",
  "Search articles": "Tìm kiếm bài viết",
  "Search by title, topic, or URL": "Tìm theo tiêu đề, chủ đề hoặc URL",
  "Search preview": "Xem trước kết quả tìm kiếm",
  "Search the whole user base. Only non-coordinators are listed.": "Tìm kiếm trên toàn bộ người dùng. Chỉ những người chưa là điều phối viên mới được hiển thị.",

  // ── Additional UI labels ───────────────────────────────────────────────
  "Preferred cities": "Thành phố mong muốn",
  "Preferred countries": "Quốc gia mong muốn",
  "Preferred study mode": "Hình thức học mong muốn",
  "Premium scholarship alerts": "Thông báo học bổng cao cấp",
  "Prerequisite": "Điều kiện tiên quyết",
  "Press “Plan my application” and you get a real, structured application for that course — the exact steps to follow, in order.": "Nhấn “Lập kế hoạch ứng tuyển” và bạn sẽ nhận được một lộ trình ứng tuyển có cấu trúc rõ ràng cho ngành học đó — các bước chính xác cần làm theo thứ tự.",
  "Preview — this {status} article is not visible to the public yet.": "Bản xem trước — bài viết ở trạng thái {status} này hiện chưa hiển thị công khai.",
  "Price": "Mức giá",
  "Pricing soon": "Sắp có mức giá",
  "Priority AI parsing and checklist generation": "Ưu tiên phân tích bằng AI và tạo danh mục hồ sơ",
  "PRIVACY AND DATA PROTECTION": "QUYỀN RIÊNG TƯ VÀ BẢO VỆ DỮ LIỆU",
  "Private · Non-profit": "Tư thục · Phi lợi nhuận",
  "Processing Time:": "Thời gian xử lý:",
  "Profile Match": "Độ phù hợp hồ sơ",
  "Programme Fit Framework": "Khung Đánh giá Độ phù hợp Ngành học",
  "Programme-grounded AI feedback": "Nhận xét AI bám sát chương trình học",
  "Programs across four colleges, co-developed with Cornell University and the University of Pennsylvania.": "Các chương trình đào tạo thuộc 4 viện, được hợp tác phát triển cùng Đại học Cornell và Đại học Pennsylvania.",
  "Promote admins or remove accounts. Admin changes apply immediately; deletions are permanent.": "Thăng cấp quản trị viên hoặc xóa tài khoản. Thay đổi quyền áp dụng ngay lập tức; thao tác xóa là vĩnh viễn.",
  "Provide truthful, accurate, and complete information and materials;": "Cung cấp thông tin và tài liệu trung thực, chính xác và đầy đủ;",
  "Provisions regarding intellectual property, privacy, disclaimers, liability limits, and dispute resolution survive termination.": "Các điều khoản liên quan đến quyền sở hữu trí tuệ, quyền riêng tư, miễn trừ trách nhiệm, giới hạn trách nhiệm và giải quyết tranh chấp vẫn tiếp tục có hiệu lực sau khi chấm dứt thỏa thuận.",

  // ── SEO & Page Metadata ────────────────────────────────────────────────
  "About GlowBal — The Team Helping Students Study Abroad": "Về GlowBal — Đội ngũ đồng hành cùng học sinh du học",
  "Meet the team behind GlowBal — passionate educators, engineers, and mentors helping Vietnamese students study globally.": "Gặp gỡ đội ngũ đứng sau GlowBal — những nhà giáo dục, kỹ sư và cố vấn tâm huyết hỗ trợ học sinh Việt Nam du học toàn cầu.",
  "About GlowBal — The Team Helping Students Study Abroad | GlowBal": "Về GlowBal — Đội ngũ đồng hành cùng học sinh du học | GlowBal",
  "Application Tracker & Saved Universities": "Theo dõi hồ sơ ứng tuyển & Trường đã lưu",
  "Track your course application progress, deadlines, and manage saved universities all in one place.": "Theo dõi tiến độ nộp hồ sơ, hạn chót và quản lý các trường đại học đã lưu tại một nơi duy nhất.",
  "How GlowBal Works — AI & Mentor Study Abroad Guidance": "Cách GlowBal hoạt động — Hướng dẫn du học với AI & Cố vấn",
  "Discover how GlowBal takes you from university search to course applications, scholarship discovery, and personalized AI strategies.": "Khám phá cách GlowBal đồng hành cùng bạn từ tìm kiếm trường đại học đến nộp hồ sơ ngành học, tìm học bổng và chiến lược AI cá nhân hóa.",
  "How GlowBal Works — AI & Mentor Study Abroad Guidance | GlowBal": "Cách GlowBal hoạt động — Hướng dẫn du học với AI & Cố vấn | GlowBal",
  "Student-first global course and university guidance platform. Discover 100+ global universities, find scholarships, and build AI application strategies.": "Nền tảng định hướng ngành học và trường đại học toàn cầu lấy học sinh làm trung tâm. Khám phá 100+ trường đại học, tìm học bổng và xây dựng chiến lược ứng tuyển bằng AI.",
  "Connect with Student Advisors & Mentors": "Kết nối với Cố vấn & Mentor du học",
  "Talk 1-on-1 with admitted students and mentors who have successfully applied to top global universities. Get honest advice, profile reviews, and interview prep.": "Trò chuyện 1-1 với các sinh viên và mentor đã ứng tuyển thành công vào các trường đại học hàng đầu thế giới. Nhận lời khuyên thực tế, đánh giá hồ sơ và luyện phỏng vấn.",
  "Connect with Student Advisors & Mentors | GlowBal": "Kết nối với Cố vấn & Mentor du học | GlowBal",
  "Talk 1-on-1 with admitted students and mentors who have successfully applied to top global universities.": "Trò chuyện 1-1 với các sinh viên và mentor đã ứng tuyển thành công vào các trường đại học hàng đầu thế giới.",
  "Study Abroad Guides, Insights & News": "Cẩm nang du học, góc nhìn chuyên sâu & Tin tức",
  "Read actionable guides on study abroad costs, scholarship application strategies, visa requirements, and student success stories.": "Đọc các bài viết hướng dẫn thực tế về chi phí du học, chiến lược xin học bổng, yêu cầu visa và câu chuyện thành công của du học sinh.",
  "Study Abroad Guides, Insights & News | GlowBal": "Cẩm nang du học, góc nhìn chuyên sâu & Tin tức | GlowBal",
  "Student-first global course and university guidance platform helping students find scholarships and build application strategies.": "Nền tảng định hướng ngành học và trường đại học toàn cầu lấy học sinh làm trung tâm, giúp học sinh tìm học bổng và xây dựng chiến lược ứng tuyển.",
  "Find Universities, Scholarships & Study Abroad Support": "Tìm trường đại học, học bổng & Hỗ trợ du học",
  "Find Scholarships & Financial Aid": "Tìm học bổng & Hỗ trợ tài chính",
  "Discover hundreds of international scholarships, government grants, and university funding opportunities tailored for Vietnamese students.": "Khám phá hàng trăm cơ hội học bổng quốc tế, học bổng chính phủ và hỗ trợ tài chính từ trường đại học dành riêng cho học sinh Việt Nam.",
  "Find Scholarships & Financial Aid | GlowBal": "Tìm học bổng & Hỗ trợ tài chính | GlowBal",
  "Discover hundreds of international student scholarships and university funding opportunities.": "Khám phá hàng trăm học bổng du học quốc tế và cơ hội hỗ trợ tài chính từ các trường đại học.",
  "University not found": "Không tìm thấy trường đại học",
  "Explore Global Universities": "Khám phá các trường đại học toàn cầu",
  ...
  // ─── Restored 2026-08-23 ────────────────────────────────────────────────
  // The uncommitted tail of this dictionary was lost to an accidental
  // overwrite. Entries below were recovered from the Turbopack dev cache
  // (compiled string literals), re-typed verbatim from a pre-loss read, or
  // reconstructed where no copy existed. See docs/current-status.md.
  '← Back to planner': '← Quay lại kế hoạch',
  '1. Core': '1. Cốt lõi',
  'A clear sequence so you always know the next move.': 'Một trình tự rõ ràng để bạn luôn biết bước tiếp theo là gì.',
  'A failed requirement makes the application currently ineligible regardless of every other score.': 'Chỉ cần một điều kiện không đạt, hồ sơ hiện tại chưa đủ điều kiện bất kể các điểm số khác.',
  ...
  'Activity Reflection': 'Suy ngẫm hoạt động',
  'Add another activity or achievement': 'Thêm một hoạt động hoặc thành tích khác',
  'Add another reflected example that clearly records your role, action and outcome.': 'Bổ sung một ví dụ đã tự nhìn nhận khác, ghi rõ vai trò, hành động và kết quả của bạn.',
  'Add more detail to your existing activities (context, action, outcome)': 'Bổ sung chi tiết cho các hoạt động đã có (bối cảnh, hành động, kết quả)',
  'Add more reflected experiences to help GlowBal identify reliable patterns across your profile.': 'Hãy bổ sung thêm các trải nghiệm đã tự nhìn nhận để GlowBal xác định những mẫu đáng tin cậy trong hồ sơ của bạn.',
  'Add or deepen experiences that show this pattern in another context, rather than relying on a single activity.': 'Bổ sung hoặc đào sâu các trải nghiệm thể hiện mẫu này trong bối cảnh khác, thay vì chỉ dựa vào một hoạt động.',
  'Add stronger supporting evidence, specific outcomes, or verification to the experiences already on your profile.': 'Bổ sung bằng chứng hỗ trợ mạnh hơn, kết quả cụ thể hoặc xác minh cho những trải nghiệm đã có trong hồ sơ.',
  'Admissions perspective': 'Góc nhìn tuyển sinh',
  'Advising & tutoring': 'Cố vấn & gia sư',
  ...
  'Anyone here ever made a mistake? Raise your hand to receive a second chance.': '“Ai ở đây đã từng sai nào, dơ tay để nhận cơ hội thứ 2 nào.”',
  ...
  'Assessed separately in the evidence framework below.': 'Được đánh giá riêng trong phần khung bằng chứng bên dưới.',
  'Assessment input is missing': 'Thiếu dữ liệu đầu vào để đánh giá',
  'At the feast between angels and demons, I am the only one invited.': 'Trên bàn tiệc giữa tiên và quỷ tao là thằng duy nhất được mời',
  'Attach supporting evidence (certificate, confirmation letter, document)': 'Đính kèm minh chứng (chứng chỉ, thư xác nhận, tài liệu)',
  'Available now': 'Đã sẵn sàng',
  'Back to Achievements': 'Quay lại Thành tích',
  ...
  'Biggest strength': 'Thế mạnh lớn nhất',
  'Build a strategy for wherever you apply.': 'Xây dựng chiến lược cho bất kỳ nơi nào bạn ứng tuyển.',
  'Build a strategy for wherever you apply. Open an application in My Portal and GlowBal builds the strategy around the exact university and course you picked.': 'Xây dựng chiến lược cho bất kỳ nơi nào bạn ứng tuyển. Mở một hồ sơ ứng tuyển trong My Portal và GlowBal sẽ xây dựng chiến lược xoay quanh đúng trường và ngành bạn đã chọn.',
  'Build depth by showing this pattern in another context rather than relying on a single experience.': 'Tạo chiều sâu bằng cách thể hiện mẫu này trong một bối cảnh khác thay vì chỉ dựa vào một trải nghiệm.',
  ...
  'Citizenship requirement': 'Yêu cầu quốc tịch',
  'Clarify the direction you want to pursue and connect it explicitly to the experiences that already support it.': 'Làm rõ hướng đi bạn muốn theo đuổi và kết nối trực tiếp hướng đó với những trải nghiệm đang hỗ trợ nó.',
  ...
  'Compare your academic profile against what the course expects.': 'So sánh hồ sơ học thuật của bạn với yêu cầu của ngành học.',
  'Compares your profile against the university and course inside an application you open in My Portal.': 'So sánh hồ sơ của bạn với trường và ngành trong một hồ sơ ứng tuyển bạn mở tại My Portal.',
  ...
  'Competitive gaps': 'Khoảng trống về tính cạnh tranh',
  'complete ·': 'hoàn thành ·',
  'Concrete things you can do to strengthen the application.': 'Những việc cụ thể bạn có thể làm để củng cố hồ sơ ứng tuyển.',
  'Confirm user choices': 'Xác nhận lựa chọn của bạn',
  'Consistent evidence': 'Bằng chứng nhất quán',
  'Continue adding specific evidence so emerging strengths can be separated from areas that genuinely need development.': 'Tiếp tục bổ sung bằng chứng cụ thể để phân biệt các thế mạnh đang hình thành với những lĩnh vực thực sự cần phát triển.',
  ...
  'Continue to the Strategy Report': 'Tiếp tục tới Báo cáo chiến lược',
  ...
  'Demonstrated Skills — one per line, as "Skill — why"': 'Kỹ năng thể hiện — mỗi dòng một mục, theo dạng "Kỹ năng — vì sao"',
  ...
  'Explore →': 'Khám phá →',
  'Explore what each report is for before you open an application and generate anything.': 'Tìm hiểu mục đích của từng báo cáo trước khi bạn mở một hồ sơ ứng tuyển và tạo bất cứ thứ gì.',
  'Faith is an expensive luxury, and money is truly spellbinding.': 'Vì niềm tin là thứ thật xa xỉ. Và đồng tiền là thứ thật ma mị.',
  ...
  'Fit breakdown and why you match': 'Phân tích độ phù hợp và vì sao bạn phù hợp',
  'Funding source': 'Nguồn tài trợ',
  'Future Connection': 'Liên hệ tương lai',
  'Gap and risk analysis': 'Phân tích khoảng trống và rủi ro',
  ...
  'GlowBal reads your reflection, achievements, and activities to find evidence-backed patterns. Missing data is called out rather than filled in by AI.': 'GlowBal đọc phần tự nhìn nhận, thành tích và hoạt động của bạn để tìm các mẫu hành vi có bằng chứng hỗ trợ. Dữ liệu còn thiếu sẽ được nêu rõ thay vì để AI tự điền.',
  ...
  'Hard criteria assessment': 'Đánh giá điều kiện bắt buộc',
  'Hard skill': 'Kỹ năng cứng',
  'Hard-skill specificity': 'Mức độ cụ thể của kỹ năng cứng',
  'Heaven has not treated me badly. If no one hires me as a developer, I will become a ride-hailing driver.': '“Con thấy ông trời đã đối xử với con không tệ. Nếu không ai thuê con Dev, con sẽ chạy xe ôm công nghệ.”',
  'Help me think': 'Giúp tôi suy nghĩ',
  'Here’s how GlowBal understood this experience': 'Đây là cách GlowBal hiểu về trải nghiệm này',
  'Hidden risks': 'Rủi ro tiềm ẩn',
  ...
  'How did this experience change the way you see yourself or your community?': 'Trải nghiệm này đã thay đổi cách bạn nhìn nhận bản thân hoặc cộng đồng như thế nào?',
  ...
  'How did your leadership influence the team or project?': 'Vai trò lãnh đạo của bạn đã ảnh hưởng thế nào đến đội nhóm hoặc dự án?',
  ...
  'How has this experience changed the way you approach learning or challenges?': 'Trải nghiệm này đã thay đổi cách bạn tiếp cận việc học hoặc thử thách như thế nào?',
  'How has this project influenced what you want to build or study next?': 'Dự án này đã ảnh hưởng thế nào đến điều bạn muốn xây dựng hoặc học tiếp theo?',
  ...
  'I grew through hardship. I rose from the ashes.': 'Tôi đã trưởng thành từ trong đau khổ. Tôi đã đứng lên từ đống tro tàn.',
  'Identify the parts of the match that need stronger evidence or positioning.': 'Xác định những phần cần bằng chứng hoặc định vị mạnh hơn.',
  'Identity evidence': 'Bằng chứng bản sắc',
  'Identity evidence profile': 'Hồ sơ bằng chứng bản sắc',
  'If they had never happened, what might be different about you?': 'Nếu những điều đó chưa từng xảy ra, bạn nghĩ bản thân mình bây giờ sẽ khác như thế nào?',
  'Imagine yourself 10 years from now. What would make you feel that your work truly mattered?': 'Hãy tưởng tượng bạn của 10 năm sau. Điều gì sẽ khiến bạn cảm thấy công việc của mình thực sự có ý nghĩa?',
  'Impact reflects how central the current gap is to your personal profile. Effort estimates whether it can be improved by clarifying current evidence or needs new experiences.': 'Tác động phản ánh mức độ trọng tâm của khoảng trống hiện tại đối với hồ sơ cá nhân. Nỗ lực ước tính liệu có thể cải thiện bằng cách làm rõ bằng chứng hiện có hay cần thêm trải nghiệm mới.',
  'Impact reflects how central the current gap is to your personal profile. Effort is an estimate based on whether the gap can be fixed by clarifying existing evidence or requires new experiences.': 'Tác động phản ánh mức độ trọng tâm của khoảng trống hiện tại đối với hồ sơ cá nhân. Nỗ lực được ước tính dựa trên việc khoảng trống có thể được khắc phục bằng cách làm rõ bằng chứng hiện có hay cần trải nghiệm mới.',
  ...
  'Keyboard: 1–6 opens a section · Esc closes · F toggles focus': 'Bàn phím: 1–6 mở một phần · Esc đóng · F bật/tắt chế độ tập trung',
  'Language requirement': 'Yêu cầu ngôn ngữ',
  'Leadership & initiative': 'Lãnh đạo & sáng kiến',
  'Life swept away my innocence and threw me into towering ambitions.': 'Cuộc sống cuốn đi sự hồn nhiên và ném vào tôi những tham vọng rất cao',
  'Limited evidence': 'Bằng chứng hạn chế',
  'Longer-term depth': 'Phát triển chiều sâu dài hạn',
  'Looking back, which experiences have shaped you the most?': 'Nhìn lại, những trải nghiệm nào đã định hình bạn nhiều nhất?',
  ...
  'No specific evidence recorded': 'Chưa ghi nhận bằng chứng cụ thể',
  ...
  'Not scored until reliable activity chronology is captured.': 'Chưa được chấm điểm cho đến khi có trình tự thời gian hoạt động đáng tin cậy.',
  'Not yet': 'Chưa',
  'One way to structure your answer: "As a result, [what changed] for [who/what]. I know this because [evidence, even if it\'s a comment or reaction rather than a number]."': 'Gợi ý cấu trúc câu trả lời: "Kết quả là, [điều thay đổi] đối với [ai/cái gì]. Tôi biết điều này nhờ [minh chứng/phản hồi nhận được]."',
  'One way to structure your answer: "Before I got involved, [situation]. I noticed / was asked to help with [opportunity] because [reason]."': 'Gợi ý cấu trúc câu trả lời: "Trước khi tôi tham gia, [bối cảnh/tình hình]. Tôi nhận thấy / được nhờ giúp đỡ về [cơ hội/vấn đề] vì [lý do]."',
  'One way to structure your answer: "I personally [specific action], which involved [step 1], [step 2] and [step 3]."': 'Một cách gợi ý để viết câu trả lời: "Tôi đã đích thân [hành động cụ thể], bao gồm [bước 1], [bước 2] và [bước 3]."',
  'One way to structure your answer: "I used to [old way of thinking/doing]. Now I [new understanding or behaviour], which surprised me because [reason]."': 'Gợi ý cấu trúc câu trả lời: "Trước đây tôi từng [cách nghĩ/cách làm cũ]. Giờ đây tôi [suy nghĩ/hành động mới], điều này khiến tôi bất ngờ vì [lý do]."',
  'One way to structure your answer: "The hardest part was [difficulty] because [reason]. I considered [option A] and [option B]."': 'Gợi ý cấu trúc câu trả lời: "Phần khó nhất là [trở ngại] vì [lý do]. Tôi đã cân nhắc [phương án A] và [phương án B]."',
  'One way to structure your answer: "This connects to what I want to study/do next because [reason]. I want to carry [specific lesson] forward."': 'Gợi ý cấu trúc câu trả lời: "Điều này gắn liền với ngành học/định hướng tương lai của tôi vì [lý do]. Tôi muốn mang theo [bài học cụ thể] cho chặng đường tới."',
  'One way to structure your answer: "This mattered to me because [personal reason]. I decided to commit when [moment/realisation]."': 'Gợi ý cấu trúc câu trả lời: "Điều này có ý nghĩa với tôi vì [lý do cá nhân]. Tôi quyết định dốc lòng thực hiện khi [khoảnh khắc/nhận thức]."',
  'One way you could structure your answer:': 'Một cách bạn có thể sắp xếp câu trả lời:',
  'Open an application first. GlowBal then generates this report for that exact university and course.': 'Hãy mở một hồ sơ ứng tuyển trước. GlowBal sẽ tạo báo cáo này cho đúng trường và ngành đó.',
  'Open an application in My Portal and GlowBal builds the strategy around the exact university and course you picked.': 'Mở một hồ sơ ứng tuyển trong My Portal và GlowBal sẽ xây dựng chiến lược xoay quanh đúng trường và ngành bạn đã chọn.',
  'Open an application in My Portal and GlowBal will build the strategy from there.': 'Mở một hồ sơ ứng tuyển trong My Portal và GlowBal sẽ xây dựng chiến lược từ đó.',
  ...
  'Priorities and actions tailored to the application you opened, with the reasoning behind each one.': 'Các ưu tiên và hành động phù hợp với hồ sơ ứng tuyển bạn đã mở, kèm lý do cho từng gợi ý.',
  ...
  'Profile, university match, reports, strategy and actions — all built from the application you choose.': 'Hồ sơ, mức độ phù hợp với trường, các báo cáo, chiến lược và hành động — tất cả được xây dựng từ hồ sơ ứng tuyển bạn chọn.',
  ...
  'Questions we still have': 'Câu hỏi chúng tôi còn băn khoăn',
  'Quick wins': 'Cải thiện nhanh',
  'Rate limit reached. Please wait a moment and try again.': 'Đã vượt quá giới hạn yêu cầu. Vui lòng đợi trong giây lát và thử lại.',
  'Rating rule: recurrence + evidence quality + verification + recorded outcomes. One activity cannot receive more than 3 stars; two cannot receive 5 stars.': 'Quy tắc xếp hạng: mức độ lặp lại + chất lượng bằng chứng + xác minh + kết quả được ghi nhận. Một hoạt động không thể nhận quá 3 sao; hai hoạt động không thể nhận 5 sao.',
  ...
  'Reflect on patterns across your experiences. All answers save automatically as you type.': 'Suy ngẫm về các định hình qua trải nghiệm của bạn. Tất cả câu trả lời được tự động lưu khi nhập.',
  ...
  'Regenerate the report with a complete profile for a personalised recommendation.': 'Tạo lại báo cáo với hồ sơ đầy đủ hơn để nhận khuyến nghị dành riêng cho bạn.',
  ...
  'Review this before we use it in your reports.': 'Hãy xem lại trước khi chúng tôi dùng nội dung này trong báo cáo của bạn.',
  'Save & exit': 'Lưu & thoát',
  'Save & update report': 'Lưu & cập nhật báo cáo',
  'Save error': 'Lỗi lưu',
  'See how GlowBal turns your profile into a strategy for any university or course you decide to apply to.': 'Xem cách GlowBal biến hồ sơ của bạn thành chiến lược cho bất kỳ trường hoặc ngành nào bạn quyết định ứng tuyển.',
  'See how you align with a chosen course.': 'Xem mức độ phù hợp của bạn với ngành đã chọn.',
  'See how your profile fits a chosen university and course.': 'Xem hồ sơ của bạn phù hợp thế nào với một trường và ngành cụ thể.',
  'See it in action': 'Xem cách hoạt động',
  'See which achievements strengthen this specific application.': 'Xem thành tích nào củng cố riêng cho hồ sơ ứng tuyển này.',
  'Select an option': 'Chọn một lựa chọn',
  'Service temporarily unavailable. Please try again shortly.': 'Dịch vụ tạm thời không khả dụng. Vui lòng thử lại sau giây lát.',
  ...
  'Start with the whole picture, then open any area to inspect the evidence and reasoning behind it.': 'Bắt đầu với bức tranh tổng thể, sau đó mở từng phần để xem bằng chứng và lý giải phía sau.',
  'State the direction you want to pursue and explicitly connect it to the experiences already supporting it.': 'Nêu rõ hướng đi bạn muốn theo đuổi và kết nối trực tiếp với các trải nghiệm đang hỗ trợ hướng đó.',
  'Stated direction': 'Hướng đi đã nêu',
  'Still developing': 'Vẫn đang phát triển',
  'Strategy recommendations become tasks inside your GlowBal workspace.': 'Các gợi ý chiến lược trở thành việc cần làm ngay trong không gian làm việc GlowBal của bạn.',
  ...
  'Strengthen an existing experience with specific outcomes or checkable supporting evidence.': 'Củng cố một trải nghiệm hiện có bằng kết quả cụ thể hoặc bằng chứng hỗ trợ có thể kiểm chứng.',
  'Strengthen this area with another specific, reflected example that shows your role, action and outcome.': 'Củng cố lĩnh vực này bằng một ví dụ cụ thể khác đã được tự nhìn nhận, thể hiện vai trò, hành động và kết quả của bạn.',
  'Strengths that are supported by your experiences and evidence.': 'Những điểm mạnh được củng cố bởi trải nghiệm và bằng chứng của bạn.',
  'Strong evidence': 'Bằng chứng mạnh',
  'Stronger positioning': 'Định vị mạnh hơn',
  'Strongest alignments': 'Điểm trùng khớp nổi bật nhất',
  ...
  'The AI could not produce a valid report. Your previous report, if any, has been kept.': 'AI chưa thể tạo báo cáo hợp lệ. Báo cáo trước đó, nếu có, vẫn được giữ nguyên.',
  'The AI could not produce a complete evidence-grounded report. Generation will retry automatically.': 'AI chưa thể tạo báo cáo đầy đủ dựa trên bằng chứng. Hệ thống sẽ tự động thử lại.',
  'The AI could not produce a complete evidence-grounded report.': 'AI chưa thể tạo báo cáo đầy đủ dựa trên bằng chứng.',
  ...
  'The highest-value improvements to focus on first.': 'Những cải thiện giá trị nhất cần tập trung trước tiên.',
  'The parts of your overall profile that could become stronger over time.': 'Những phần trong hồ sơ tổng thể của bạn có thể trở nên mạnh hơn theo thời gian.',
  'The reasoning behind each recommendation.': 'Lý do đằng sau mỗi đề xuất.',
  'The recurring roles, behaviours and patterns that describe who you consistently show yourself to be.': 'Các vai trò, hành vi và mẫu lặp lại mô tả con người mà bạn liên tục thể hiện.',
  'The strongest named capabilities extracted from your evidence. Scores represent evidence strength, not ability ceilings.': 'Các năng lực nổi bật nhất được rút ra từ bằng chứng của bạn. Điểm số thể hiện độ mạnh của bằng chứng, không phải giới hạn năng lực.',
  'The strongest named capabilities in this report snapshot. Scores represent strength of supporting evidence, not an ability ceiling.': 'Các năng lực nổi bật nhất được nêu tên trong phiên bản báo cáo này. Điểm số thể hiện độ mạnh của bằng chứng hỗ trợ, không phải giới hạn năng lực.',
  'The strongest recurring signals across your profile, evidence and experiences — not tied to any one university.': 'Những tín hiệu lặp lại mạnh nhất trong hồ sơ, bằng chứng và trải nghiệm của bạn — không gắn với riêng một trường nào.',
  'The tangible activities, outcomes and verification that make the claims in your profile credible.': 'Các hoạt động, kết quả và xác minh hữu hình giúp những nhận định trong hồ sơ của bạn trở nên đáng tin cậy.',
  'The themes and directions emerging from the choices you repeatedly make — presented as possibilities, not predictions.': 'Các chủ đề và hướng đi nổi lên từ những lựa chọn bạn lặp lại — được trình bày như những khả năng, không phải dự đoán.',
  'The themes and patterns that consistently show up across your profile.': 'Những chủ đề và khuôn mẫu lặp lại nhất quán trong hồ sơ của bạn.',
  'Thematic convergence': 'Sự hội tụ chủ đề',
  'Theme depth': 'Độ sâu của chủ đề',
  'Theme maturity': 'Độ trưởng thành của chủ đề',
  'These are evidence-backed themes already present in your experiences. They are possibilities to explore, not career predictions.': 'Đây là các chủ đề có bằng chứng hỗ trợ đã xuất hiện trong trải nghiệm của bạn. Chúng là những khả năng để khám phá, không phải dự đoán nghề nghiệp.',
  'These are evidence-health signals from your reflected experiences. They describe how strongly GlowBal can support the identity analysis — not how “good” your personality is.': 'Đây là các tín hiệu về chất lượng bằng chứng từ những trải nghiệm bạn đã tự nhìn nhận. Chúng mô tả mức độ GlowBal có thể hỗ trợ phân tích bản sắc — không phải đánh giá tính cách của bạn “tốt” đến đâu.',
  'These bars show recurrence across motivations you explicitly recorded. They are not personality scores.': 'Các thanh này cho thấy mức độ lặp lại trong những động lực bạn đã ghi nhận rõ ràng. Đây không phải điểm số tính cách.',
  'These bars show recurrence across the motivations you explicitly recorded. They are not personality scores.': 'Các thanh này cho thấy mức độ lặp lại trong những động lực bạn đã ghi nhận rõ ràng. Đây không phải điểm số tính cách.',
  'Think about the biggest challenge you’ve faced. How did it change the way you think or act?': 'Hãy nghĩ về thử thách lớn nhất bạn từng đối mặt. Nó đã thay đổi cách bạn suy nghĩ hoặc hành động như thế nào?',
  'Think about your best moments. What made you feel proud, not because of awards, but because of what you accomplished?': 'Hãy nghĩ về những khoảnh khắc đẹp nhất của bạn. Điều gì khiến bạn tự hào, không phải vì giải thưởng, mà vì những gì bạn đã đạt được?',
  'Think about:': 'Hãy nghĩ về:',
  'This is the direction you explicitly stated, shown separately from AI-inferred emerging themes.': 'Đây là hướng đi bạn đã nêu rõ, được hiển thị riêng với các chủ đề đang hình thành do AI suy luận.',
  'This is your reusable personal foundation. It does not belong to one university or course.': 'Đây là nền tảng cá nhân dùng lại được của bạn. Nó không thuộc về riêng một trường hay ngành nào.',
  'This score measures how well your profile aligns with this programme. It is not an admission probability or acceptance chance.': 'Điểm này đo mức độ hồ sơ của bạn tương thích với chương trình — không phải xác suất trúng tuyển hay cơ hội được nhận.',
  'This short animation shows how a student moves from profile to strategy — open an application in My Portal to see it built for real.': 'Đoạn hoạt ảnh ngắn này cho thấy cách một sinh viên đi từ hồ sơ đến chiến lược — hãy mở một hồ sơ ứng tuyển trong My Portal để thấy nó được xây dựng thật sự.',
  'Three reports. Each one answers a different question.': 'Ba báo cáo. Mỗi báo cáo trả lời một câu hỏi khác nhau.',
  ...
  'Understand how your interests and experiences connect to the subject.': 'Hiểu cách sở thích và trải nghiệm của bạn liên kết với ngành học.',
  ...
  'We saved your reflection, but couldn’t create the summary.': 'Chúng tôi đã lưu bài suy ngẫm của bạn, nhưng chưa thể tạo bản tóm tắt.',
  'We’ve brought across the information you’ve already given GlowBal. Check that everything is still correct before we analyse this application.': 'Chúng tôi đã mang sang những thông tin bạn đã cung cấp cho GlowBal. Hãy kiểm tra lại mọi thứ vẫn còn chính xác trước khi chúng tôi phân tích hồ sơ này.',
  'What became different about you afterwards?': 'Sau sự kiện đó, bạn đã trở nên khác biệt như thế nào?',
  ...
  'What did building this project teach you about solving problems?': 'Việc xây dựng dự án này đã dạy bạn điều gì về cách giải quyết vấn đề?',
  'What did you achieve, and what does that achievement represent to you?': 'Bạn đã đạt được điều gì, và thành tích đó có ý nghĩa gì với bạn?',
  ...
  'What it means': 'Điều đó có nghĩa gì',
  'What keeps pulling your attention, even when nobody asks you to do it?': 'Điều gì luôn thu hút sự chú ý của bạn, ngay cả khi không ai yêu cầu bạn làm?',
  ...
  'What repeatedly motivates your choices, where those motivations appear in your experiences, and how confidently the evidence supports them.': 'Những điều liên tục thúc đẩy lựa chọn của bạn, nơi các động lực đó xuất hiện trong trải nghiệm và mức độ bằng chứng hỗ trợ chúng.',
  'What responsibility or opportunity did you take on?': 'Bạn đã đảm nhận trách nhiệm hoặc cơ hội gì?',
  'What role do you naturally seem to take on?': 'Bạn thường tự nhiên đảm nhận vai trò gì khi ở trong một tập thể?',
  'What strengthens your application': 'Điều củng cố hồ sơ của bạn',
  ...
  'What was the situation, and how did you become part of it?': 'Tình huống đó là gì, và bạn đã trở thành một phần của nó như thế nào?',
  'What was the toughest leadership decision you had to make?': 'Quyết định lãnh đạo khó khăn nhất bạn từng phải đưa ra là gì?',
  'What we would like to see': 'Điều chúng tôi mong được thấy',
  'What would you carry forward from this experience?': 'Bạn sẽ mang theo bài học hoặc giá trị gì từ trải nghiệm này?',
  'What would you still spend time on if nobody judged or paid you?': 'Điều gì bạn vẫn sẵn sàng dành thời gian làm kể cả khi không ai đánh giá hay trả công?',
  'What your evidence demonstrates you can do, how those strengths combine, and the positioning they create for you as an applicant.': 'Những điều bằng chứng cho thấy bạn có thể làm, cách các thế mạnh kết hợp và vị thế chúng tạo ra cho bạn với tư cách ứng viên.',
  'What your evidence shows you can do': 'Những điều bằng chứng cho thấy bạn có thể làm',
  'When were you genuinely proud of your contribution?': 'Khi nào bạn cảm thấy thực sự tự hào về sự đóng góp của chính mình?',
  ...
  'Where the current evidence is limited and where stronger proof could make the profile more complete. This is diagnosis, not your application strategy.': 'Những nơi bằng chứng hiện tại còn hạn chế và bằng chứng mạnh hơn có thể giúp hồ sơ hoàn thiện hơn. Đây là chẩn đoán, không phải chiến lược ứng tuyển của bạn.',
  'Where the current evidence is limited, what still needs development, and where stronger proof could make the profile more complete.': 'Những nơi bằng chứng hiện tại còn hạn chế, điều vẫn cần phát triển và nơi minh chứng mạnh hơn có thể giúp hồ sơ hoàn thiện hơn.',
  'Where your profile is well supported and where detail is still thin.': 'Nơi hồ sơ của bạn được củng cố tốt và nơi chi tiết vẫn còn mỏng.',
  ...
  'Which problems, topics or communities do you keep returning to?': 'Những vấn đề, chủ đề hoặc cộng đồng nào mà bạn luôn muốn quay trở lại tìm hiểu hoặc tham gia?',
  'Who is this applicant?': 'Ứng viên này là ai?',
  'Who or what would you want your work to benefit?': 'Bạn muốn công việc của mình mang lại lợi ích cho ai hoặc điều gì?',
  ...
  'Why did you choose to participate (and even take the lead)?': 'Vì sao bạn chọn tham gia (và thậm chí đứng ra dẫn dắt)?',
  ...
  'Why does that matter personally?': 'Tại sao điều đó lại có ý nghĩa đặc biệt với cá nhân bạn?',
  ...
  'You don’t need polished answers. A few honest sentences is enough.': 'Bạn không cần câu trả lời hoàn hảo. Vài câu thật lòng là đủ.',
  ...
  'Your competitive advantage is still emerging from the evidence currently available.': 'Lợi thế cạnh tranh của bạn vẫn đang dần hình thành từ các bằng chứng hiện có.',
  ...
  'Your stated direction is separated from evidence-backed emerging themes. The latter are possibilities to explore, not career predictions.': 'Hướng đi bạn đã nêu được tách riêng khỏi các chủ đề đang hình thành có bằng chứng hỗ trợ. Các chủ đề này là khả năng để khám phá, không phải dự đoán nghề nghiệp.',
  'Your strongest differentiator will become clearer as you add more reflected experiences.': 'Điểm khác biệt mạnh nhất của bạn sẽ rõ hơn khi bạn bổ sung thêm các trải nghiệm đã tự nhìn nhận.',
  'Strategic Overview': 'Tổng quan chiến lược',
  'Current position': 'Vị trí hiện tại',
  'Strategic goal': 'Mục tiêu chiến lược',
  'Expected outcome': 'Kết quả kỳ vọng',
  'Top three priorities': 'Ba ưu tiên hàng đầu',
  'Strategic Priority Table': 'Bảng ưu tiên chiến lược',
  'You can edit this table — your changes are saved separately and survive regeneration.': 'Bạn có thể chỉnh sửa bảng này — thay đổi được lưu riêng và vẫn còn sau khi tạo lại báo cáo.',
  Safety: 'An toàn',
  'Strong Match': 'Phù hợp mạnh',
  Reach: 'Tầm với',
  'Currently ineligible': 'Hiện chưa đủ điều kiện',
  'Not enough data to classify': 'Chưa đủ dữ liệu để phân loại',
  'Not met': 'Chưa đạt',
  'Not verified': 'Chưa xác minh',
  'Profile Development Strategy': 'Chiến lược phát triển hồ sơ',
  'Current status': 'Trạng thái hiện tại',
  'Strategic focus': 'Trọng tâm chiến lược',
  'Current competitive advantage': 'Lợi thế cạnh tranh hiện tại',
  'What makes you unique': 'Điều làm nên điểm độc đáo của bạn',
  'How to amplify it': 'Cách khuếch đại lợi thế này',
  'Desired admissions perception': 'Ấn định mong muốn nơi hội đồng tuyển sinh',
  'Narrative Strategy': 'Chiến lược tự sự',
  'Core narrative': 'Tự sự cốt lõi',
  'Admissions value': 'Giá trị với tuyển sinh',
  'Consistency check': 'Kiểm tra tính nhất quán',
  'What supports it': 'Điều củng cố nó',
  'What feels disconnected': 'Điều còn rời rạc',
  Emphasise: 'Nhấn mạnh',
  'Play a supporting role': 'Đóng vai trò hỗ trợ',
  'Execution Roadmap': 'Lộ trình thực thi',
  'Key actions': 'Hành động then chốt',
  Deliverables: 'Sản phẩm cần hoàn thành',
  'Open tool': 'Mở công cụ',
  'Success criteria': 'Tiêu chí thành công',
  'Current situation': 'Tình hình hiện tại',
  'Expected impact': 'Tác động kỳ vọng',
  'Turn this roadmap into Planner tasks': 'Biến lộ trình này thành việc cần làm trong Kế hoạch',
  'Adds the deliverables from each phase above to your Planner as tasks you can track. Safe to click again after this report regenerates — it updates the same tasks rather than duplicating them.': 'Thêm sản phẩm cần hoàn thành của từng giai đoạn ở trên vào Kế hoạch dưới dạng việc bạn có thể theo dõi. Bấm lại sau khi báo cáo được tạo lại cũng an toàn — hệ thống cập nhật đúng các việc đó thay vì nhân bản.',
  // Caught by scripts/check-i18n.mjs after the restore: one verbatim from the
  // pre-loss read, four gaps left by the uncommitted feature work itself.
  'Impact level {level} of 5': 'Mức ảnh hưởng {level}/5',
  Answered: 'Đã trả lời',
  ...
  // Matching Report v2 presentation.
  'First Impression': 'Ấn tượng đầu tiên',
  'What Strengthens Your Application': 'Điều củng cố hồ sơ của bạn',
  'Questions We Still Have': 'Những câu hỏi còn bỏ ngỏ',
  "What We'd Like to See": 'Điều hội đồng muốn thấy',
  'Focus immediately on validating entry eligibility criteria.': 'Ưu tiên xác minh ngay các tiêu chí đủ điều kiện đầu vào.',
  'Deepen specific evidence in your portfolio and personal statement highlighting your alignment with this curriculum.': 'Bổ sung bằng chứng cụ thể trong portfolio và bài luận cá nhân để làm rõ mức độ phù hợp với chương trình này.',
  "Admissions committees look for coherence between your past work, current skills, and future ambition.": 'Hội đồng tuyển sinh tìm kiếm sự nhất quán giữa trải nghiệm trước đây, năng lực hiện tại và định hướng tương lai của bạn.',
  'Evaluation & Assessment': 'Đánh giá và nhận định',
  'No specific assessment recorded for this dimension.': 'Chưa có đánh giá cụ thể cho khía cạnh này.',
  'Documented Evidence': 'Bằng chứng đã ghi nhận',
  'Admissions Reader Takeaway': 'Điểm hội đồng tuyển sinh cần lưu ý',
  'Focus area: {gap}': 'Trọng tâm cần cải thiện: {gap}',
  'Strong positive signal that reinforces applicant distinction.': 'Tín hiệu tích cực mạnh, củng cố điểm khác biệt của ứng viên.',
  'Meets baseline expectations for this cohort.': 'Đáp ứng kỳ vọng nền tảng của nhóm ứng viên này.',
  'Fit Analysis': 'Phân tích mức độ phù hợp',
  'Dimensional evaluation across course prerequisites and applicant profile': 'Đánh giá theo từng khía cạnh giữa yêu cầu khóa học và hồ sơ ứng viên',
  'Fit Analysis Column Chart': 'Biểu đồ cột phân tích mức độ phù hợp',
  'N/A': 'Không áp dụng',
  'Critical Gap': 'Khoảng trống nghiêm trọng',
  'Competitive Gap': 'Khoảng trống cạnh tranh',
  'Suggested focus': 'Trọng tâm đề xuất',
  'Prioritise addressing before submitting application': 'Ưu tiên xử lý trước khi nộp hồ sơ',
  'Can be reinforced through supporting materials or personal statement': 'Có thể củng cố bằng tài liệu bổ trợ hoặc bài luận cá nhân',
  'Low risk': 'Rủi ro thấp',
  Blocking: 'Đang chặn hồ sơ',
  'High risk': 'Rủi ro cao',
  Unchecked: 'Chưa kiểm tra',
  Eligible: 'Đủ điều kiện',
  'Action required': 'Cần hành động',
  'To verify': 'Cần xác minh',
  'Overall Match': 'Mức độ phù hợp tổng thể',
  'Application Readiness': 'Mức độ sẵn sàng của hồ sơ',
  'Confidence Level': 'Mức độ tin cậy',
  '{level} alignment overall based on verified profile competencies.': 'Mức độ phù hợp tổng thể {level}, dựa trên các năng lực hồ sơ đã được xác minh.',
  'Profile shows documented foundational experience for this course.': 'Hồ sơ thể hiện nền tảng kinh nghiệm đã được ghi nhận phù hợp với khóa học này.',
  'Resolve pending eligibility verification to unlock submission confidence.': 'Hoàn tất xác minh điều kiện còn thiếu để tăng sự tự tin khi nộp hồ sơ.',
  'Target key growth in {dimension} to maximize competitiveness.': 'Tập trung phát triển {dimension} để tối đa hóa năng lực cạnh tranh.',
  'Refine {dimension} to strengthen application distinction.': 'Tinh chỉnh {dimension} để làm nổi bật điểm khác biệt của hồ sơ.',
  'Strengthen your narrative alignment with university priorities.': 'Tăng cường sự đồng nhất giữa câu chuyện cá nhân và ưu tiên của trường.',
  'Biggest Strength': 'Thế mạnh lớn nhất',
  'Core Profile Alignment': 'Mức độ phù hợp cốt lõi của hồ sơ',
  'Positive foundation': 'Nền tảng tích cực',
  'Biggest Opportunity': 'Cơ hội lớn nhất',
  'Strategic Focus Area': 'Trọng tâm chiến lược',
  'High-impact enhancement': 'Cải thiện có tác động lớn',
  'Next Best Action': 'Hành động tốt nhất tiếp theo',
  'Execute Strategic Roadmap': 'Thực hiện lộ trình chiến lược',
  'Convert these insights into prioritized application tasks with step-by-step guidance.': 'Chuyển các nhận định này thành nhiệm vụ hồ sơ được ưu tiên, kèm hướng dẫn từng bước.',
  'Critical Requirements': 'Yêu cầu then chốt',
  'Strongest Alignment Areas': 'Các khía cạnh phù hợp nhất',
  'Important Gaps': 'Khoảng trống quan trọng',
  'Programme Criteria Breakdown': 'Phân tích tiêu chí chương trình',
