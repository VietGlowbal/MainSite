...
export const REPORT_PROMPT_VERSIONS: Record<ReportPromptId, string> = {
  ...
  report_narrative_synthesis: 'report-synthesis-v18-reference-style-anchor-grounding',
