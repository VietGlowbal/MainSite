...
/**
 * What every consumer of `ProfileEvaluation` gets when there is no programme
 * attached — a user-level Personal Report, for instance. Every dimension is
 * `not_available` and the classification is `insufficient_data`, which is an
