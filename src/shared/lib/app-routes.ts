...
const ROUTES: readonly RoutePattern[] = [
  ...
  { pattern: '/advisors/apply/success', trail: ['Advisors', 'Become an advisor', 'Application sent'] },
  { pattern: '/advisors/apply', trail: ['Advisors', 'Become an advisor'] },
  { pattern: '/advisors/:id', trail: ['Advisors', 'Advisor'], dynamic: { 1: { key: 'advisor', fallback: 'Advisor' } } },
  { pattern: '/advisors', trail: ['Advisors'] },
...
const CRUMB_HREFS: readonly { pattern: string; hrefs: readonly (string | null)[] }[] = [
  ...
  { pattern: '/advisors/apply/success', hrefs: ['/advisors', '/advisors/apply', null] },
  { pattern: '/advisors/apply', hrefs: ['/advisors', null] },
  { pattern: '/advisors/:id', hrefs: ['/advisors', null] },
