...
Experiment run: `semantic-tuition-offline-20260911T054434Z`
...
- Retained content-source coverage: **100.0%**
...
Artifacts: `manifest.json`, `attempts.jsonl`, `results.jsonl`, `source-inventory.jsonl`, `evaluation.json`.
