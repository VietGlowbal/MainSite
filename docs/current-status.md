...
Code snapshot: **working tree**, branched from `main` at `5a78a1f` (PR #168,
"Rebuild the header animation inside the header's own bounds, per spec",
