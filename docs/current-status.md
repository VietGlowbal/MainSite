...
Code snapshot: **working tree**, branched from `main` at `e61545e` (PR #169,
"Size the header animation to fill its height…", merged). Not yet
committed/pushed at the time this document was written — see "Last completed
work" below.
